...
function legalcontract_approval_pdf($legalapprove)
{
    return app_pdf('legalcontract_approval', LIBSPATH . 'pdf/Legalcontract_approval_pdf', $legalapprove);
}
/**
...
function hearing_notice_pdf($hearing)
{
    return app_pdf('hearing_notice', LIBSPATH . 'pdf/Hearing_notice_pdf', $hearing);
}
function legal_approval_pdf($legalapprove)
{
    return app_pdf('legal_approval', LIBSPATH . 'pdf/Legal_approval_pdf', $legalapprove);
}
function legal_general_approval_pdf($legalapprove)
{
    return app_pdf('legal_general_approval', LIBSPATH . 'pdf/Legal_general_approval_pdf', $legalapprove);
}
function legal_creditrevision_approval_pdf($legalapprove)
{
    return app_pdf('legal_creditrevision_approval', LIBSPATH . 'pdf/Legal_creditrevision_approval_pdf', $legalapprove);
}
function legal_creditapplication_approval_pdf($legalapprove)
{
    return app_pdf('legal_creditapplication_approval', LIBSPATH . 'pdf/Legal_creditapplication_approval_pdf', $legalapprove);
}
function legal_close_approval_pdf($legalapprove)
{
    return app_pdf('legal_close_approval', LIBSPATH . 'pdf/Legal_close_approval_pdf', $legalapprove);
}
function legal_police_approval_pdf($legalapprove)
{
    return app_pdf('legal_police_approval', LIBSPATH . 'pdf/Legal_police_approval_pdf', $legalapprove);
}
function communication_center_pdf($project)
{
    return app_pdf('project_communication', LIBSPATH . 'pdf/Communication_center_pdf', $project);
}
function expense_approval_pdf($expenseapprove)
{
    return app_pdf('expense_statement', LIBSPATH . 'pdf/Expense_statement_pdf', $expenseapprove);
}
function expense_approvalall_pdf($expenseapprove)
{
    return app_pdf('expenseall_statement', LIBSPATH . 'pdf/Expenseall_statement_pdf', $expenseapprove);
}
function legal_chequehold_approval_pdf($legalapprove)
{
    return app_pdf('legal_chequehold_approval', LIBSPATH . 'pdf/Legal_chequehold_approval_pdf', $legalapprove);
}
function legal_pdc_approval_pdf($legalapprove)
{
    return app_pdf('legal_pdc_approval', LIBSPATH . 'pdf/Legal_pdc_approval_pdf', $legalapprove);
}
function matter_overview_pdf($id)
{
    return app_pdf('matter_overview', LIBSPATH . 'pdf/Matter_overview_pdf', $id);
}
function litigation_collective_report_pdf($litigation)
{
    return app_pdf('litigation_collective_report_pdf', LIBSPATH . 'pdf/Litigation_collective_report_pdf', $litigation);
}
function litigation_collective_reportupdate_pdf($litigation)
{
    return app_pdf('litigation_collective_reportupdate_pdf', LIBSPATH . 'pdf/Litigation_collective_reportupdate_pdf', $litigation);
}
