...
function app_init_project_tabs()
{
	...
	$CI->app_tabs->add_project_tab('project_submatter', [
        'name'     => _l('project_submatter'),
        'icon'     => 'fa fa-file',
        'view'     => 'admin/projects/project_submatter',
        'position' => 6,
       ]);  
    $CI->app_tabs->add_project_tab('project_case_details', [
        'name'     => _l('project_case_details'),
        'icon'     => 'fa fa-balance-scale',
        'view'     => 'admin/projects/project_case_details',
        'position' => 6,
    ]);

   /* $CI->app_tabs->add_project_tab('hearings', [
        'name'     => _l('hearings'),
        'icon'     => 'fa fa-gavel',
        'view'     => 'admin/projects/project_hearings',
        'position' => 7,
    ]);*/
		 $CI->app_tabs->add_project_tab('project_subfiles', [
        'name'                      => _l('project_final_documents'),
        'icon'                      => 'fa fa-files-o',
        'view'                      => 'admin/projects/project_docfiles',
        'position'                  => 8,
	    'visible'					=>(get_option('allow_staff_view_project_subfile') == 1)
        ]);
    ...
    $CI->app_tabs->add_project_tab('project_judgment', [
        'name'                      => _l('project_judgement'),
        'icon'                      => 'fa fa-handshake-o',
        'view'                      => 'admin/projects/project_judgement',
        'position'                  => 10,
       ]);
    $CI->app_tabs->add_project_tab('project_updates', [
        'name'     => _l('project_updates'),
        'icon'     => 'fa fa-pencil',
        'view'     => 'admin/projects/project_updates',
        'position' => 11,
    ]);
 $CI->app_tabs->add_project_tab('project_settlement', [
        'name'                      => _l('project_settlement'),
        'icon'                      => 'fa fa-handshake-o',
        'view'                      => 'admin/projects/project_settlement',
        'position'                  => 12,
       ]);
    ...
    $CI->app_tabs->add_project_tab('scope', [
        'name'                      => _l('scope'),
        'icon'                      => 'fa fa-edit',
        'view'                      => 'admin/projects/scope',
        'position'                  => 21,
    ]);

    $CI->app_tabs->add_project_tab('communication_center', [
        'name'                      => _l('communication_center'),
        'icon'                      => 'fa fa-envelope',
        'view'                      => 'admin/projects/communication_center',
        'position'                  => 22,
    ]);

	 $CI->app_tabs->add_project_tab('court_order', [
        'name'                      => _l('project_courts'),
        'icon'                      => 'fa fa-gavel',
        'view'                      => 'admin/projects/project_court_orders',
        'position'                  => 26,
        'linked_to_customer_option' => ['upload_files'],
    ]);
    ...
    /*
	$CI->app_tabs->add_project_tab('payment_schedule', [
        'name'                      => _l('payment_schedule'),
        'icon'                      => 'fa fa-handshake-o',
        'view'                      => 'admin/projects/project_payschedule',
        'position'                  => 12,
       ]);
