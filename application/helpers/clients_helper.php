...
function app_init_customer_profile_tabs()
{
    ...
    $CI->app_tabs->add_customer_profile_tab('overview', [
        'name'     => _l('client_overview'),
        'icon'     => 'fa fa-th',
        'view'     => 'admin/clients/groups/overview',
        'position' => 4,
    ]);
    ...
    $CI->app_tabs->add_customer_profile_tab('contacts', [
        'name'     => !is_empty_customer_company($client_id) || empty($client_id) ? _l('Stakeholder') : _l('Stakeholder'),
        'icon'     => 'fa fa-users',
        'view'     => 'admin/clients/groups/contacts',
        'position' => 10,
    ]);
    $CI->app_tabs->add_customer_profile_tab('shareholders', [
        'name'     => _l('Shareholders'),
        'icon'     => 'fa fa-users',
        'view'     => 'admin/clients/groups/shareholders',
        'position' => 10,
    ]);
...
/*
    ...
    //$CI->app_tabs->add_customer_profile_tab('teams_meeting', [
     //   'name'     => _l('teams_meetings'),
     //   'icon'     => 'fa fa-clock-o',
      //  'view'     => 'admin/clients/groups/teams_meeting',
      //  'position' => 91,
    //]);

    $CI->app_tabs->add_customer_profile_tab('constitution', [
        'name'     => _l('customer_attachments1'),
        'icon'     => 'fa fa-paperclip',
        'view'     => 'admin/clients/groups/letterheads',
        'position' => 81,
    ]);
...
function get_all_contact_user_id($userid)
{
    $CI = &get_instance();
