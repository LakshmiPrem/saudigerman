...
function get_company_logo($uri = '', $href_class = '', $type = '')
{
   ...
   /* if($uri == ''){
        $logo = "<span style='color:black; font-size:25px;'><strong>$company_name</strong></span>";
    }else{
        $logo = "<span style='color:white; font-size:25px;'><strong>$company_name</strong></span>";
    }*/

    $logo = '<a  class="' . $href_class . ' logo logo-text">' . $company_name . '</a>';
