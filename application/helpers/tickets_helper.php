...
function AdminTicketsTableStructure($name = '', $bulk_action = false)
{
    ...
    $table .= '<th class="toggleable" id="th-department">' . _l('customer_name') . '</th>';
    $table .= '<th class="toggleable" id="th-code">' . _l('customer_code') . '</th>';
	 $table .= '<th class="toggleable" id="th-tags">' . _l('reference_no') . '</th>';
   $table .= '<th class="toggleable ticket_created_column" id="th-created">' . _l('ticket_date_created') . '</th>';
	  $table .= '<th class="toggleable" id="th-status">' . _l('total_amount') . '</th>';
