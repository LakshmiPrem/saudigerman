...
function app_init_settings_tabs()
{
    ...
    /* $CI->app_tabs->add_settings_tab('casediary', [
        'name'     => _l('projects'),
        'view'     => 'admin/settings/includes/casediary',
        'position' => 30,
    ]);*/
	...
	$CI->app_tabs->add_settings_tab('msoffice', [
        'name'     => 'Office 365',
        'view'     => 'admin/settings/includes/msoffice',
        'position' => 83,
    ]);
	$CI->app_tabs->add_settings_tab('whatsapp', [
        'name'     => _l('whatspp'),
        'view'     => 'admin/settings/includes/whatsapp_api',
        'position' => 84,
    ]);
    $CI->app_tabs->add_settings_tab('openai', [
        'name'     => _l('openai'),
        'view'     => 'admin/settings/includes/openai',
        'position' => 80,
    ]);
	$CI->app_tabs->add_settings_tab('docusign', [
        'name'     => _l('docusign'),
        'view'     => 'admin/settings/includes/docusign',
        'position' => 85,
    ]);
   ...
   /* $CI->app_tabs->add_settings_tab('teams', [
        'name'     => _l('teams'),
        'view'     => 'admin/settings/includes/teams',
        'position' => 96,
    ]);*/
}
