...
*
*/
define('APP_BASE_URL', 'https://boscocloud.boscogrp.com/smartlegal/');
 ...
 */
define('APP_DB_USERNAME', 'boscoleg_admin');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '3fVb1]_*xqQ1');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'boscoleg_legal_counsel_db');
