...
*
*/
define('APP_BASE_URL', 'https://slc-demo.beveron.net/saudigerman/');
...
*/
define('APP_ENC_KEY', '9c6aa441ba16610824eef1f02767ad08');
 ...
 */
define('APP_DB_USERNAME', 'bevera9w_bever');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '{.%h7H*vxXcP');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'bevera9w_smartlegal_saudigerman_db');
