...
define('AGREEMENT_FOLDER', FCPATH . 'uploads/agreements' . '/');
define('FEE_PROPOSAL_FOLDER', FCPATH . 'uploads/fee_proposal' . '/');
define('CORPORATE_RECOVERY_FOLDER', FCPATH . 'uploads/corporate_recovery' . '/');
define('IP_FOLDER', FCPATH . 'uploads/intellectual_property' . '/');
define('TRADE_LICENSE_FOLDER', FCPATH . 'uploads/trade_license' . '/');
define('OPPOSITEPARTY_FOLDER', FCPATH . 'uploads/oppositeparty' . '/');
define('INSTALLMENT_FOLDER', FCPATH . 'uploads/installment' . '/');
define('LEGALRISK_FOLDER', FCPATH . 'uploads/legalrisk' . '/');
//  Contact profile images
define('CLIENT_SUBFILE_FOLDER', FCPATH . 'uploads/client_profile_images' . '/');
define('CHEQUEBOUNCE_FOLDER', FCPATH . 'uploads/chequebounce' . '/');
define('TEMPLATE_FOLDER', FCPATH . 'uploads/templates' . '/');
define('OCR_FOLDER', FCPATH . 'uploads/ocr' . '/');

//document
define('DOCUMENTS_ATTACHMENTS_FOLDER',FCPATH.'uploads/documents'.'/');
define('DOCUMENTS_IN_ATTACHMENTS_FOLDER',FCPATH.'uploads/documents_in'.'/');
define('DOCUMENTS_OUT_ATTACHMENTS_FOLDER',FCPATH.'uploads/documents_out'.'/');
define('REPORTS_FOLDER', FCPATH . 'uploads/reports' . '/');
define('ESIGNATURE_FOLDER',FCPATH . 'uploads/esignature' . '/');
