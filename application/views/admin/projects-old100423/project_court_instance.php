...
<div class="modal-body">
  <div class="row"> <!-- row2 -->
            ...
            <?php #########  Client Position    ###############?>
            <div class="col-md-4 border-right">
            <?php $selected = (isset($court_instance) ? $court_instance->client_position : 'defendant'); ?>
            <?php echo render_select('client_position',$position_arr,array('id','name'),'client_position',$selected);?>
          </div>

          <?php #########  Opposite Party Position    ###############?>
          <div class="col-md-4 border-right">
            <?php $selected = (isset($court_instance) ? $court_instance->opposite_party_position : 'plaintiff'); ?>
          ...
          <?php ##########  Lawyer Attending ########## ?>
            ...
            <?php 
					   $selected = []; 
              if(isset($court_instance->lawyer_id)){  
