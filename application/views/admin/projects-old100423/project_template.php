          <?php echo form_hidden('lawyer_id',$proposal->assigned); ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <?php //if(!isset($project)){
                            ...
                            $case_type = (isset($case_type) ? $case_type : 'court_case'); 

                            $selected = (isset($project) ? $project->case_type : $case_type);
                            echo render_select('case_type',$case_types,array('id','name'),'case_type',$selected,array());?>
                        <?php //} ?>
                       <?php  $selected = (isset($proposal->matter_template_id) ? $proposal->matter_template_id : ''); ?>
...
<script type="text/javascript">
    ...
    function apply_in_available_features(type){
        ...
        }else if(type == 'legal_consultancy' || type == 'personal_law'){ 
            CaseDetailsTab.prop('selected',true);
