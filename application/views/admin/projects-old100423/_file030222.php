         ...
         <div class="modal-body">
            <div class="row">
               <div class="col-md-6 border-right project_file_area">
                  ...
                  <div class="col-md-6">
                     <?php echo render_input('issue_date','issue_date',$value,'date',array('onblur'=>'update_file_data('.$file->id.')')); ?> 
                  </div>
                  <?php $value = (isset($file->expiry_date) ? $file->expiry_date : _d(date('Y-m-d'))); ?>
                   <div class="col-md-6">
                     <?php echo render_input('expiry_date','expiry_date',$value,'date',array('onblur'=>'update_file_data('.$file->id.')')); ?> 
                  </div>
                  </div>
