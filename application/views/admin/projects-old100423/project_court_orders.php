      ...
      <div class="row">
        ...
        <?php $value=_d(date('Y-m-d')); ?>
          <?php echo render_date_input('order_date','corder_date',$value); ?>
              ...
              <div class="col-md-3">
        <?php $value=_d(date('Y-m-d')); ?>
          <?php echo render_date_input('end_date','cend_date',$value); ?>
          </div>
           <div class="col-md-3">
          ...
          <?php echo render_textarea('remark','remark','',array('rows'=>2,'required'=>'true'),array(),'',''); ?>
          </div>
