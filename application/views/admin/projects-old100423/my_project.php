                   ...
                   <!--     <div class="col-md-6">
                    ...
                    ?>
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                          <?php $value = (isset($project) ? $project->lawyer_id : ''); ?>
              <?php echo render_select('lawyer_id',$lawyer_staffs,array('staffid',array('firstname','lastname')),'lawyer_attending',$value);
							 ?>
						</div>
                        <div class="col-md-6">
                         <?php
...
<script type="text/javascript">
    ...
    function apply_in_available_features(type){
       ...
       if(type == 'court_case' || type = 'labour_case'|| type = 'personal_law'){ 
        ...
        }else if(type == 'legal_consultancy' || type == 'personal_law' || type == 'policecase' || type == 'other_projects' ){ 
            CaseDetailsTab.prop('selected',true);
			ExpenseTab.prop('selected',true);
			emailTab.prop('selected',true);
			LegalTab.prop('selected',true);
