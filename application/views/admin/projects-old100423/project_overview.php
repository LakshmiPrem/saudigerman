         ...
         <table class="table no-margin project-overview-table">
            <tbody>
              ...
              <tr class="project-overview-customer">
                  ...
                  <td>
                      <a href="<?php echo admin_url(); ?>opposite_parties/opposite_party/<?php echo $project->opposite_party; ?>">
                        <?php echo get_opposite_party_name($project->opposite_party); ?>
                      </a>
                  </td>
              </tr>
        ...
        <!-- <tr class="project-overview-total-logged-hours">
         ...
         <tr class="project-overview-case-type">
          ...
          <tr class="project-overview-case-type">
            ...
            <td><?php echo _l($project->pf_agreement_no); ?></td>
         </tr>
         <tr class="project-overview-case-type">
...
<div class="team-members project-overview-team-members">
   ...
   <div class="tc-content project-overview-description">
   <hr class="hr-panel-heading project-area-separation" />
   <p class="bold font-size-14 project-info"><?php echo _l('lawyer_attending'); ?></p>
   <?php if(count($asslawyers) == 0){
	 ...
	 foreach($asslawyers as $plawyer){
	   ...
	   <div class="clearfix"></div>
	   <hr class="hr-panel-heading project-area-separation" />
   <p class="bold font-size-14 project-info"><?php echo _l('legal_coordinator'); ?></p>
   ...
   <div class="clearfix"></div>
      ...
      <div class="col-md-12">
         <p class="text-uppercase bold text-dark font-medium">
           &emsp; <a class="" data-toggle="collapse" href="#lcourtinstance" role="button" aria-expanded="false" aria-controls="collapseExample"><?php echo _l('court_instance_details'); ?></a>
         </p>
...
<div class="row">
   <div class="col-md-12 project-overview-expenses-finance">
      ...
      <div class="col-md-3">
         ...
         <p class="bold font-medium"><?php echo app_format_money($project->claiming_amount+sum_from_table(db_prefix().'expenses',array('where'=>array('project_id'=>$project->id),'field'=>'amount')), $currency); ?></p>
      </div>
      <div class="col-md-3">
...
<div class="row">
   <div class="col-md-12 project-overview-expenses-finance">
      <div class="col-md-4">
         <p class="text-uppercase text-muted"><?php echo _l('settlement_amount'); ?></p>
      ...
      <div class="col-md-4">
         ...
         <p class="bold font-medium"><?php echo app_format_money(sum_from_table(db_prefix().'recoveries_installments',array('where'=>array('recovery_id'=>$project->id,'installment_status'=>'paid'),'field'=>'installment_amount')), $currency); ?></p>
      </div>
      <div class="col-md-4">
         <p class="text-uppercase text-success"><?php echo _l('project_overview_settle_balance'); ?></p>
...
<div class="project-overview-timesheets-chart">
    <div class="row">
      <div class="col-md-12">
         <p class="text-uppercase bold text-dark font-medium">
           &emsp; <a class="" data-toggle="collapse" href="#lcourtupdate" role="button" aria-expanded="false" aria-controls="collapseExample"><?php echo _l('project_court_attach_grant'); ?></a>
         </p>
