        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <span class="edit-title"><?php echo _l('edit_meeting'); ?></span>
                    <span class="add-title"><?php echo _l('new_meeting'); ?></span>
                </h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div id="additional_discussion"></div>
                         <?php echo render_datetime_input('meeting_date','meeting_date'); ?>
                        <?php echo render_input('location','location'); ?>
                        <?php echo render_input('subject','agenda'); ?>
                        <?php echo render_textarea('description','minutes_of_meetings','',array(),array(),'','tinymce');  ?>
