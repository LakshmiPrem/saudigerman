<div class="modal-header task-single-header" data-task-single-id="<?php echo $task->id; ?>" data-status="<?php echo $task->status; ?>">
   ...
   <small class="no-margin">
      ...
      <a href="#" class="hide" onclick="make_task_public(<?php echo $task->id; ?>); return false;">
...
<div class="modal-body">
   <div class="row">
      ...
      <p class="no-margin pull-left mright5 hide">
      ...
      <?php if($task->billed == 0){
         ...
         <p class="no-margin pull-left hide"<?php if(!$is_assigned){ ?> data-toggle="tooltip" data-title="<?php echo _l('task_start_timer_only_assignee'); ?>"<?php } ?>>
         ...
         <?php if(total_rows('tbltaskstimers',array('end_time'=>NULL,'staff_id !='=>get_staff_user_id(),'task_id'=>$task->id)) > 0){
          ...
          <?php if(has_permission('tasks','','edit')){ ?><a href="#" onclick="edit_temp_task_inline_description(this,<?php echo $task->id; ?>); return false;" class="pull-left mtop10 mleft5 font-medium-xs"><i class="fa fa-pencil-square-o"></i></a>
          <?php } ?>
          <div class="clearfix"></div>
         ...
         <div class="clearfix"></div>
         <hr />
         <a href="#" onclick="add_temp_task_checklist_item('<?php echo $task->id; ?>'); return false" class="mbot10 inline-block ">
         ...
         <div class="row checklist-items-wrapper ">
            <div class="col-md-12 ">
               <div id="checklist-items">
                  <?php   $this->load->view('admin/tasks/temp_checklist_items_template',
                     array(
                       'task_id'=>$task->id,
   ...
   <?php } ?>
   <!-- <hr /> -->
   <a class="hide" href="#" id="taskCommentSlide" onclick="slideToggle('.tasks-comments'); return false;" >
      <h4 class="mbot20 font-medium"><?php echo _l('task_comments'); ?></h4>
   </a>
   <div class="tasks-comments inline-block full-width simple-editor hide" <?php if(count($task->comments) == 0){echo 'style="display:none"';} ?>>
...
<div class="col-md-4 task-single-col-right hide">
   <div class="pull-right mbot10 task-single-menu task-menu-options">
      <div class="content-menu hide">
         <ul>
            <?php if(has_permission('tasks','','edit')) { ?>
            <!-- <li>
               <a href="#" onclick="edit_task_temp(<?php echo $task->id; ?>); return false;">
         ...
         <li>
            <a href="<?php echo admin_url('tasks/delete_temp_task/'.$task->id); ?>" class="_delete task-delete">
...
<?php } ?>
<div class="task-info task-single-inline-wrap task-info-start-date hide">
...
<div class="task-info task-info-due-date task-single-inline-wrap<?php if(!$task->duedate && !has_permission('edit','','tasks')){echo ' hide';} ?> hide"<?php if(!$task->duedate){ echo ' style="opacity:0.5;"';} ?>>
      ...
      <span class="task-single-menu task-menu-priority">
         ...
         <span class="content-menu hide">
            <ul>
               ...
               <li>
                  <a href="#" onclick="temp_task_change_priority(<?php echo $priority['id']; ?>,<?php echo $task->id; ?>); return false;">
...
<div class="task-info task-info-user-logged-time hide">
   <h5>
...
<?php } ?>
<?php if(has_permission('tasks','','create')){ ?>
<div class="task-info task-info-total-logged-time hide">
   <h5>
...
<div id="inputTagsWrapper" class="taskSingleTasks task-info-tags-edit hide">
   <input type="text" class="tagsinput" id="taskTags" data-taskid="<?php echo $task->id; ?>" value="<?php echo prep_tags_input(get_tags_in($task->id,'task_template')); ?>" data-role="tagsinput">
</div>
<div class="clearfix"></div>
<?php } else { ?>
<div class="mtop5 clearfix"></div>
<?php //echo render_tags(get_tags_in($task->id,'task_template')); ?>
<div class="clearfix"></div>
<?php } ?>
<hr class="task-info-separator" />
<div class="clearfix"></div>
...
<h4 class="task-info-heading font-normal font-medium-xs hide"><i class="fa fa-user-o" aria-hidden="true"></i> <?php echo _l('task_single_assignees'); ?></h4>
<?php if(has_permission('tasks','','edit') || has_permission('tasks','','create')){ ?>
<div class="simple-bootstrap-select hide">
...
<?php } ?>
<div class="task_users_wrapper hide">
   <?php
   $_assignees = '';
   foreach ($task->assignees as $assignee) {
    $_remove_assigne = '';
...
<!-- <hr class="task-info-separator" />
 --><!-- <div class="clearfix"></div>
 --><h4 class="task-info-heading font-normal font-medium-xs hide">
...
<div class="text-center mtop10 hide">
   <div id="dropbox-chooser-task" class="hide"></div>
</div>
<?php } ?>
</div>
</div>
