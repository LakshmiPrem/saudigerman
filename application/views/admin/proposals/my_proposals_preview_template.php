   ...
   <div class="panel-body">
      ...
      <div class="row mtop10">
         ...
         <div class="col-md-9 text-right _buttons proposal_buttons">
            ...
            <?php $path =  base_url('uploads/fee_proposal/').$proposal->id.'/Fee Proposal.docx'; ?>

            <?php $file_path   = get_upload_path_by_type('fee_proposal').$proposal->id.'/';
            if(file_exists($file_path.'Fee Proposal.docx')){ ?>
            <!-- <a href="<?php echo $path; ?>"  class="btn btn-default btn-with-tooltip" data-toggle="tooltip" download title="<?php echo _l('fee_proposal'); ?>" data-placement="bottom"><i class="fa fa-file-word-o" aria-hidden="true"></i></a> -->
            <?php } ?>
            ...
            <div class="btn-group">
               ...
               <ul class="dropdown-menu dropdown-menu-right">
                  ...
                  <?php if(has_permission('projects','','create')){ 
                     if($proposal->converted_to_matter == 'n') 
                        $disable_matter_convert = false;
                     else
                        $disable_matter_convert = true;
                  ?>

                  <li <?php if($disable_matter_convert){ echo 'data-toggle="tooltip" title="'._l($help_text,_l('proposal_convert_matter')).'"';}  elseif($disable_convert){ echo 'data-toggle="tooltip" title="'._l($help_text,_l('proposal_convert_matter')).'"';}  ?>><a href="#" <?php if($disable_matter_convert || $disable_convert){ echo 'style="cursor:not-allowed;" onclick="return false;"';} else {echo 'data-template="matter" onclick="convert_matter_template(this); return false;"'; }?> ><?php echo _l('proposal_convert_matter'); ?></a></li>
                  <?php } ?>
               </ul>
            </div>
            <?php } ?>
...
<script>
   ...
   init_tabs_scrollable();
     ...
     function convert_matter_template(invoker) { 
    ...
    } else if (template == 'matter') {
        html_helper_selector = 'matter';
    } else {
        return false;
    }
