                        ...
                        <ul class="nav nav-tabs no-margin nav-tabs-horizontal" role="tablist">
                            <li role="presentation" class="<?php if($ticket->service ==1 && !isset($confirmapproval)){ if(!$this->session->flashdata('active_tab')){echo ' active';}} ?>">
                              <a href="#civilrequest" aria-controls="addcivil" role="tab" data-toggle="tab" class="<?php if($ticket->service !=1)echo 'hide'?>">
                                 <?php echo _l('ticket_single_add_civil'); ?><?$confirmapproval?>
                              </a>
                           </li>
	...
	if(isset($police)&& ($police->owner_detail!='')){
      ...
      <div class="clearfix"></div><br>
             ...
             <?php echo form_close(); ?>
                  ...
                  <div role="tabpanel" class="tab-pane <?php if($this->session->flashdata('active_tab_settings')){echo 'active';} ?>" id="addreply">
                     <hr class="no-mtop" />
               ...
               <div role="tabpanel" class="tab-pane <?php if($ticket->service !=1 && $ticket->service !=2 ){ if(!$this->session->flashdata('active_tab')){echo 'active';}} ?>"  id="settings">
                  <hr class="no-mtop" />
                  <div class="col-md-12">
