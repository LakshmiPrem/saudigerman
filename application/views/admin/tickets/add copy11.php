				...
				<div class="panel_s">
					...
					<div class="panel-footer attachments_area">
						<div class="row attachments">
							<div class="col-md-12 attachment">
								<div class="col-md-4 mbot15" id="doctype">
								      <div class="form-group">
                  ...
                  <select class="form-control" name="document_type[]">
                     ...
                     <?php } ?>
									...
									<input type="text" name="document_number[]" placeholder="Enter Document Number" class="form-control"  />
								
										</div></div>
									<div class="col-md-3 mbot15 hide"  id="docname">
									 <div class="form-group">
									<label for="cars"><?php echo _l('document_name'); ?></label>
									<input type="text" name="document_name[]" placeholder="Enter Document Name" class="form-control"  />
										</div>
						</div>
									<div class="col-md-2 mbot15 hide"  id="docnation">
                   <div class="form-group">
                  ...
                  <label for="cars"><?php echo _l('expiry_date'); ?></label>
									<input type="date" name="expiry_date[]" placeholder="Enter Expiry Date" class="form-control" />
	...
	$(function(){
		...
		//$('#document_type').prop('required',true);
			...
			else if(cttype=='6')
			{
				...
				$('#doctype').removeClass('col-md-offset-2');
				$('input[name="customer_code"]').prop('required',true);
				$('.attachments input[name*="attachments"]').prop('required',true);
				 $('select[name*="document_type"]').prop('required',true);
			}
