   ...
   <div class="content">
                  ...
                  <div class="horizontal-scrollable-tabs">
                     ...
                     <div class="horizontal-tabs">
                        <ul class="nav nav-tabs no-margin nav-tabs-horizontal" role="tablist">
                            <li role="presentation" class="<?php if(($ticket->service ==get_option('ticket_civilcase_service'))&& !isset($confirmapproval)){ if(!$this->session->flashdata('active_tab')){echo ' active';}} ?>">
                              <a href="#civilrequest" aria-controls="addcivil" role="tab" data-toggle="tab" class="<?php if($ticket->service !=get_option('ticket_civilcase_service'))echo 'hide'?>">
                                 <?php echo _l('ticket_single_add_civil'); ?>
                              </a>
                           </li>
                              <li role="presentation" class="<?php if(($ticket->service ==get_option('ticket_policecase_service'))&& !isset($confirmapproval)){ if(!$this->session->flashdata('active_tab')){echo ' active';}} ?>">
                              <a href="#policerequest" aria-controls="addpolice" role="tab" data-toggle="tab" class="<?php if($ticket->service !=get_option('ticket_policecase_service'))echo 'hide'?>">
                                 <?php echo _l('ticket_single_add_police'); ?>
                              </a>
                           </li>
                            <li role="presentation" class="active<?php if($ticket->service !=get_option('ticket_civilcase_service') && $ticket->service !=get_option('ticket_policecase_service') && !isset($confirmapproval)){ if(!$this->session->flashdata('active_tab') ){echo 'active';}} ?>">
                           <a href="#settings" aria-controls="settings" role="tab" data-toggle="tab">
                              <?php echo _l('ticket1_single_settings'); ?>
                           </a>
                        	</li>
                         
                           <li role="presentation" class="<?php if($this->session->flashdata('active_tab_settings')&& !isset($confirmapproval)){echo 'active';} ?>" >
                           ...
                           <li role="presentation">
                              <a href="#reassign" aria-controls="reassign" role="tab" data-toggle="tab">
                                 <?php echo _l('ticket_single_reassign'); ?>
                              </a>
                           </li>
                           <li role="presentation">
                        ...
                        <?php if(get_option('enable_legal_request_approval')==1) { ?>
                        <li role="presentation" >
         ...
         <div class="panel_s">
            <div class="panel-body">
               <div class="row">
                  <div class="col-md-8">
                     <h3 class="mtop4 mbot20 pull-left">
                        ...
                        <?php if($ticket->project_id != 0){
                         ...
                         <!-- <span class=" clock"> -->
                        <!-- <?php  //$current_datetime = new DateTime(); $datetime_a = new DateTime($reassign_latest->date_added); $interval = $current_datetime->diff($datetime_a);$difference_in_days = $interval->days; $difference_in_hours = $interval->h; $difference_in_minutes = $interval->i; $difference_in_seconds = $interval->s; $hours_display = str_pad($difference_in_hours, 2, '0', STR_PAD_LEFT); $minutes_display = str_pad($difference_in_minutes, 2, '0', STR_PAD_LEFT); $seconds_display = str_pad($difference_in_seconds, 2, '0', STR_PAD_LEFT); echo "Time Covered: " . $difference_in_days . " days, " . $difference_in_hours . "H :" . $difference_in_minutes."M ";  ?> -->
                     <!-- </span> -->
                     <span class="clock" data-placement="bottom" data-toggle="tooltip" title="Time covered" id="clock" style="font-size: 55%;">
                  ...
                  <div class="col-md-4 text-right">
                     ...
                     <div class="row">
                      ...
                      <?php }
								  else if(($ticket->service==get_option('ticket_creditrevision_service'))){ ?>
                      <a target="_blank" href="<?php echo admin_url('tickets/legal_creditrevision_approval/'.$ticket->ticketid); ?>" class="btn btn-warning btn-with-tooltip" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Download Legal Request"> <i class="fa fa-file-pdf-o"></i><?='Legal Credit Revision Request';?>  </a>
                      <?php
							  }
								  else if($ticket->service==get_option('ticket_creditapplication_service')){ ?>
                      <a target="_blank" href="<?php echo admin_url('tickets/legal_creditapplication_approval/'.$ticket->ticketid); ?>" class="btn btn-warning btn-with-tooltip" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Download Legal Request"> <i class="fa fa-file-pdf-o"></i><?='Legal Credit Application Request';?>  </a>
                      <?php
							  }
								  else if($ticket->service==get_option('ticket_legalclosure_service')){ ?>
                      ...
                      <?php
								  ...
								  else if($ticket->service=='17'){ ?>
                      <a target="_blank" href="<?php echo admin_url('tickets/legal_chequehold_approval/'.$ticket->ticketid); ?>" class="btn btn-warning btn-with-tooltip" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Download Legal Request"> <i class="fa fa-file-pdf-o"></i><?=$ticket->service_name. ' Request';?>  </a>
                      <?php
							  }
								  else if($ticket->service=='18'){ ?>
                      <a target="_blank" href="<?php echo admin_url('tickets/legal_pdc_approval/'.$ticket->ticketid); ?>" class="btn btn-warning btn-with-tooltip" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Download Legal Request"> <i class="fa fa-file-pdf-o"></i><?='Legal '.$ticket->service_name. ' Request';?>  </a>
                      <?php
							  }
								  
							  else{ ?>
                      <a target="_blank" href="<?php echo admin_url('tickets/legal_general_approval/'.$ticket->ticketid); ?>" class="btn btn-warning btn-with-tooltip" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Download Legal Request"> <i class="fa fa-file-pdf-o"></i><?=_l('legal_general_request');?>  </a>
                      <?php
							  }}?>
                       </div>
                        ...
                        <div class="col-md-4 col-md-offset-4">
                           <?php  if(is_admin()){
                                 ...
                                 $attrstat=array('disabled'=>true);
}
                                          ?>
                           <?php echo render_select('status_top',$statuses,array('ticketstatusid','name'),'',$ticket->status,$attrstat,array(),'no-mbot','',false); ?>
                        </div>
                     </div>
                  </div>
                  <div class="clearfix"></div>
               ...
               <div class="tab-content">
                                         <div role="tabpanel" class="tab-pane <?php if(($ticket->service ==get_option('ticket_civilcase_service'))&& !isset($confirmapproval)){ if(!$this->session->flashdata('active_tab')){echo 'active';}} ?>" id="civilrequest">
                  <hr class="no-mtop" />
                  <div class="row">
                    <?php echo form_open_multipart('',array('id'=>'civil-ticket-form','name'=>'civil-ticket-form','novalidate'=>true)); ?>
                     <div class="col-md-3">
	...
	if(isset($civil)&& ($civil->guarantee_chequedet!='')){
                ...
                <table class="table table-bordered" id="dynamic_field_owner1">  
                  ...
                  <th><small class="req text-danger">* </small><?=_l('contact11')?></th>
                    <th><?=_l('contact21')?></th>
			...
			$i=0;
                     ...
                     <td><input type="text" name="owner_detail[owner_name][]" placeholder="Enter Owner Name" class="form-control" value=""  /><br><input type="text" name="owner_detail[nationality][]" placeholder="Enter Nationality" class="form-control" value=""  />
                        <br><input type="text" name="owner_detail[ownstatus][]" placeholder="Enter Present Status" class="form-control" value=""  /></td> 
                         ...
                         <td>  <div class="form-group"><textarea  name="owner_detail[contact1][]" rows="3" class="form-control" id="ownerdet1"></textarea></div></td> 
      ...
      <div class="clearfix"></div><br>
               ...
               <div class="row">
                  <div class="col-md-12 text-center">
                     <hr />
                     <?php 
					  if(get_approvalticket_record_status($ticket->ticketid,$ticket->service_slug)){?>
            ...
            <!-- ###Police Request -->
             <div role="tabpanel" class="tab-pane <?php if(($ticket->service ==get_option('ticket_policecase_service'))&& !isset($confirmapproval)){ if(!$this->session->flashdata('active_tab')){echo 'active';}} ?>" id="policerequest">
                  <hr class="no-mtop" />
	...
	if(isset($police)&& ($police->owner_detail!='')){
                  ...
                  <tr id="srow<?=$i?>" class="dynamic-added-owner"> 
                      ...
                      <input type="text" name="owner_detail[nationality][]" placeholder="Enter Nationality" class="form-control" value="<?=$ownerdet['nationality'][$i]?>"  /> <br>
                        <input type="text" name="owner_detail[ownstatus][]" placeholder="Enter Present Status" class="form-control" value="<?=$ownerdet['ownstatus'][$i]?>"  /></td> 
                         ...
                         <td><div class="form-group"><textarea  name="owner_detail[contact1][]" rows="3" class="form-control" id="ownerdet12"><?=$ownerdet['contact1'][$i]?> </textarea></div></td> 
                         <td><textarea  name="owner_detail[contact2][]" rows="3" class="form-control"><?=$ownerdet['contact2'][$i]?></textarea></td> 
                       <?php 
							 if($i==0){
								 ?>
			...
			$i=0;
                     ...
                     <td><input type="text" name="owner_detail[owner_name][]" placeholder="Enter Owner Name" class="form-control" value=""  /><br><input type="text" name="owner_detail[nationality][]" placeholder="Enter Nationality" class="form-control" value=""  />
                        <br><input type="text" name="owner_detail[ownstatus][]" placeholder="Enter Present Status" class="form-control" value=""  /></td> 
                         ...
                         <input type="text" name="owner_detail[passport][]" placeholder="Enter Passport No & Expiry" class="form-control" value=""  />
                         <br><input type="text" name="owner_detail[email][]" placeholder="Enter Email" class="form-control" value=""  /></td> 
                         <td><div class="form-group"><textarea  name="owner_detail[contact1][]" rows="3" class="form-control"></textarea></div></td> 
                         <td><textarea  name="owner_detail[contact2][]" rows="3" class="form-control"></textarea></td> 
      ...
      <div class="clearfix"></div><br>
             ...
             <?php echo form_close(); ?>
                   ...
                   <div role="tabpanel" class="tab-pane <?php if($this->session->flashdata('active_tab_settings')&& !isset($confirmapproval)){echo 'active';} ?>" id="addreply">
                     <hr class="no-mtop" />
                  ...
                  <div>
                     ...
                     <div class="panel_s ticket-reply-tools">
                        ...
                        <div class="panel-body">
                           <div class="row">
                              <div class="col-md-5">
                                 <?php // echo render_select('status',$statuses,array('ticketstatusid','name'),'ticket_single_change_status',get_option('default_ticket_reply_status'),array('disabled'=>true),array(),'','',false); ?>
                                 ...
                                 <div class="checkbox"><!--checked-->
                                    <input type="checkbox" <?php echo hooks()->apply_filters('ticket_add_response_and_back_to_list_default',''); ?> name="ticket_add_response_and_back_to_list" value="1" id="ticket_add_response_and_back_to_list">
               ...
               <div class="panel_s no-shadow">
                  ...
                  <div class="media lead-note">
                     ...
                     <div class="media-body">
                        ...
                        <a href="#" class="pull-right text-danger" onclick="delete_lead_note(this,<?php echo $note['id']; ?>, <?php echo $ticket->id; ?>);return false;"><i class="fa fa fa-times"></i></a>
               ...
               <div role="tabpanel" class="tab-pane" id="reassign">
                  <hr class="no-mtop" />
                  <h4 class="customer-profile-group-heading"><?php echo _l('ticket_single_reassign'); ?></h4>
<div class="col-md-12">

 <a href="#" class="btn btn-success mtop15 mbot10" onclick="slideToggle('.usernote'); return false;"><?php echo _l('new_assign'); ?></a>
 <div class="clearfix"></div>
<div class="row">
 ...
 <?php echo form_open(admin_url('tickets/add_reassign'),['id'=>'add_reassign','class'=>'add_reassign']); ?>
 ...
 <?php echo form_hidden('current_department',$ticket->department); ?>

<div class="row">
   <div class="col-md-4"> <?php echo render_select('assign_department',$departments,array('departmentid','name'),'assign_department'); ?>
</div>
<div class="col-md-4">  <?php echo render_select('status',$statuses_reassign,array('ticketstatusid','name'),'status'); ?>
</div>
<div class="col-md-4"><?php echo render_date_input('deadline','deadline'); ?></div>
</div>
...
<div class="col-md-8">
<?php echo render_textarea( 'remark', 'remarks', '',array( 'rows'=>5)); ?>

</div></div>
 <?php // $attrdep=array('disabled'=>true); echo render_select('current_department',$departments,array('departmentid','name'),'current_department',$ticket->department,$attrdep); ?>
...
<table class="table dt-table scroll-responsive table-reassign-list" data-order-col="7" data-order-type="desc">
        <thead>
            <tr>
                <th >
                    <?php echo _l( 'transferd_from'); ?>
                </th>
                <th>
                    <?php echo _l( 'transferd_to'); ?>
                </th>
                <th>
                    <?php echo _l( 'assigned_from'); ?>
                </th>
                <th>
                    <?php echo _l( 'assigned_to'); ?>
                </th>
                <th>
                    <?php echo _l( 'start_date'); ?>
                </th>
                <th>
                    <?php echo _l( 'deadline'); ?>
                </th>
                <th>
                    <?php echo _l( 'time_used'); ?>
                </th>
                <th width="15%">
                    <?php echo _l('status'); ?>
                </th>
        ...
        <tbody>
            <?php foreach($user_reassigns as $reassign){ ?>
            <tr>
             <td><?php echo get_department_name_by_id($reassign['current_department']); ?></td>  
             <td><?php echo get_department_name_by_id($reassign['assign_department']); ?></td>  
             <td><?php echo get_staff_full_name($reassign['assigned_by']); ?></td>  
             <td><?php echo get_staff_full_name($reassign['assigned']); ?></td>  
             <td><?php echo _l($reassign['date_added']); ?></td>
             <td><?php echo _l($reassign['deadline']); ?></td>
             <td><?php
$date_added = $reassign['date_added'];
$end_date = $reassign['end_date'] ?? date('Y-m-d H:i:s'); // Use current datetime if end_date is null

$datetime_added = new DateTime($date_added);
$datetime_end = new DateTime($end_date);

$interval = $datetime_end->diff($datetime_added);

$difference_in_days = $interval->days;
$difference_in_hours = $interval->h;
$difference_in_minutes = $interval->i;

$days_display = str_pad($difference_in_days, 2, '0', STR_PAD_LEFT);
$hours_display = str_pad($difference_in_hours, 2, '0', STR_PAD_LEFT);
$minutes_display = str_pad($difference_in_minutes, 2, '0', STR_PAD_LEFT);

echo '<span  data-placement="bottom" data-toggle="tooltip" title="Time covered"  >'. $days_display . " days " . $hours_display . ":" . $minutes_display.
    '</span>';
//echo "Time covered: " . $days_display . " days " . $hours_display . ":" . $minutes_display;
?>
</td>
             <td><?php
             if(get_staff_user_id()==$reassign['assigned']||get_staff_user_id()==$reassign['assigned_by']||is_admin()) {
             echo render_select('reassign_status',$statuses_reassign,array('ticketstatusid','name'),'',$reassign['status'],['onchange'=>"change_reassign_status(this,'".$reassign['id']."');"],[],'','',false,false);}else {
                echo get_reassign_satatus_by_id($reassign['status']); }?> </td>  
             <td><?php echo $reassign['remark']; ?></td>  
   ...
   <?php } ?>
               ...
               <div role="tabpanel" class="tab-pane active<?php if($ticket->service !=get_option('ticket_civilcase_service') && $ticket->service !=get_option('ticket_policecase_service') && !isset($confirmapproval)){ if(!$this->session->flashdata('active_tab')){echo 'active';}} ?>" id="settings">
                  <hr class="no-mtop" />
                  <div class="col-md-12">
	    ...
	    echo render_select('service',$services,array('serviceid','name'),'ticket_settings_service',$ticket->service,array('disabled'=>true));
						...
						<div class="col-md-6">
						 <div class="form-group">
                        <?php 	echo render_select('opposteparty',$oppositeparty_names,array('id','name'),'opposite_party',$ticket->opposteparty,array('required'=>'true')); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="assigned" data-live-search="true" id="assigned" class="form-control selectpicker" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                           ...
                           <div class="col-md-6">
							<?php $yes_no_arr = [['id'=>'no','name'=>'No'],['id'=>'yes','name'=>'Yes']]  ?>
								  <?php echo render_select('amount_related',$yes_no_arr,array('id','name'),'amount_relatednot',$ticket->amount_related);?>
						   </div>
                     <?php $hide_amount_rel = ($ticket->amount_related == 'yes') ? '' : 'hide';?>
							<div class="col-md-6 <?php echo $hide_amount_rel ?>" id="div_file_amount">
								<?php echo render_input('file_amount','amt_case',$ticket->file_amount,'number'); ?>
						</div>
						</div>
                     <div class="row">
                     ...
                     <div class="col-md-6" >
							<?php $value=_d($ticket->deadline) ; ?>
							<?php echo render_date_input('deadline','deadline',$value); ?> 
							</div>
                     ...
                     <div class="form-group select-placeholder projects-wrapper<?php if($ticket->userid == 0){echo ' hide';} ?>">
						...
						<?php if(($ticket->service==get_option('ticket_creditapplication_service'))){?>
                          <?php echo render_input('credit_saleperson','credit_saleperson',$ticket->credit_saleperson,'text'); ?>
						<?php } ?>	
               <?php if(($ticket->service=='18')){?>
                          <?php echo render_input('ldc_salesperson','ldc_salesperson',$ticket->ldc_salesperson,'text'); ?>
						<?php } ?>	
                  </div>
                  <div class="col-md-12">
                     <?php echo render_custom_fields('tickets',$ticket->ticketid); ?>
               	...
               	<?php if($ticket->service==get_option('ticket_legalclosure_service')){?>
				...
				<div class="panel_s">
					...
					<div class="panel-body">
						...
						<div class="col-md-4">
							...
							<div class="col-md-4">
								<?php echo render_input('legalrequest_no','legalrequest_no',$ticket->legalrequest_no,'text'); ?>
							</div>
                ...
                <table class="table table-bordered" id="dynamic_field_ldccheque">  
                   <thead>
                    ...
                    <tbody>
                       ...
                       <?php if(isset($ticket)&& ($ticket->ldc_chequedet!='')){
						
						$ldccases=json_decode($ticket->ldc_chequedet,true);
							$limit=sizeof($ldccases['chequeno']);
							for($i=0;$i<$limit;$i++) {
				
						 ?>
                      <tr id="llrow<?=$i?>" class="dynamic-added-ldccheque">
                     
                     <td><input type="text" name="ldc_chequedet[chequecount][]" placeholder="Enter Cheque Count" class="form-control" value="<?=$ldccases['chequecount'][$i]?>"  /></td>
                      <td><input type="text" name="ldc_chequedet[chequeno][]" placeholder="Enter Cheque Number" class="form-control" value="<?=$ldccases['chequeno'][$i]?>"  /></td>
                      <td><input type="text" name="ldc_chequedet[chequeamount][]" placeholder="Enter Cheque Amount" class="form-control" value="<?=$ldccases['chequeamount'][$i]?>"  /></td>
                      <td><input type="date" name="ldc_chequedet[chequedt][]" placeholder="Enter Date" class="form-control" value="<?=$ldccases['chequedt'][$i]?>"  /></td>
                      <td><input type="text" name="ldc_chequedet[receive_month][]" placeholder="Enter Month" class="form-control" value="<?=$ldccases['receive_month'][$i]?>"  /></td>
                      <td><input type="text" name="ldc_chequedet[allocate_amount][]" placeholder="Enter Amount" class="form-control" value="<?=$ldccases['allocate_amount'][$i]?>"  /></td>
                      <td><input type="text" name="ldc_chequedet[act_period][]" placeholder="Enter Actual Period" class="form-control" value="<?=$ldccases['act_period'][$i]?>"  /></td>
                      <td><input type="text" name="ldc_chequedet[excess_days][]" placeholder="Enter Excess Days" class="form-control" value="<?=$ldccases['excess_days'][$i]?>"  /></td>
                      <?php 
							 if($i==0){
								 ?>
                        ...
                        <?php } else{ ?>
                        <td><button type="button" name="remove" id="<?=$i ?>" class="btn btn-danger btn_ldccheque_remove">X</button></td>
                        <?php } ?>
                ...
                <table class="table table-bordered" id="dynamic_field_ldcother">  
                   <thead>
                    ...
                    <tbody>
                       ...
                       <?php if(isset($ticket)&& ($ticket->ldc_chequeothers!='')){
						
						$ldccases1=json_decode($ticket->ldc_chequeothers,true);
							$limit=sizeof($ldccases1['approveday']);
							for($i=0;$i<$limit;$i++) {
                      ...
                      <td><input type="text" name="ldc_chequeothers[approveday][]" placeholder="Approved Days" class="form-control" value="<?=$ldccases1['approveday'][$i]?>"  /></td>
                      <td><input type="text" name="ldc_chequeothers[saleyear][]" placeholder="Current Year Sale" class="form-control" value="<?=$ldccases1['saleyear'][$i]?>"  /></td>
                      <td><input type="text" name="ldc_chequeothers[total][]" placeholder="Total Collection" class="form-control" value="<?=$ldccases1['total'][$i]?>"  /></td>
                      <td><input type="text" name="ldc_chequeothers[pendmonth][]" placeholder="Pending Month" class="form-control" value="<?=$ldccases1['pendmonth'][$i]?>"  /></td>
                      <td><input type="text" name="ldc_chequeothers[pendamount][]" placeholder="Pending Amount" class="form-control" value="<?=$ldccases1['pendamount'][$i]?>"  /></td>
                      <td><input type="text" name="ldc_chequeothers[average][]" placeholder="Avaerage Period" class="form-control" value="<?=$ldccases1['average'][$i]?>"  /></td>
                      <td><input type="text" name="ldc_chequeothers[retcheque][]" placeholder="Return Cheque" class="form-control" value="<?=$ldccases1['retcheque'][$i]?>"  /></td>
                      <td><input type="text" name="ldc_chequeothers[retstatus][]" placeholder="Status" class="form-control" value="<?=$ldccases1['retstatus'][$i]?>"  /></td>
					  ...
					  <td><button type="button" name="addldcchequeothers" id="addldcchequeothers" class="btn btn-success"><i class="fa fa-plus"></i></button></td>  
                        ...
                        <?php } else{ ?>
                        <td><button type="button" name="remove" id="<?=$i ?>" class="btn btn-danger btn_ldcother_remove">X</button></td>
                        <?php } ?>
	...
	?>
         ...
         <?php if($ticket->service=='17'){?>
		<div class="row" id="chequeapp">
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-heading">
					...
					<div class="panel-body">
						...
						<div class="col-md-4">
						<div class="form-group">
						<?php echo render_date_input('doe','doe',_d($ticket->doe)); ?>
							</div>	
						</div>
						<div class="col-md-4">
								<?php echo render_input('sister_concern','sister_concern',$ticket->sister_concern,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('typeof_business','typeof_business1',$ticket->typeof_business,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('typeof_license','typeof_license',$ticket->typeof_license,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('partner_name','partner_name',$ticket->partner_name,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('holdnationality','nationality',$ticket->holdnationality,'text'); ?>
							</div>
							 <div class="col-md-4">
							  <div class="form-group">
            ...
            <label for="cars"><?=_l('pp_avail')?></label>
               ...
               <select name="pp_avail" id="pp_avail" class="form-control selectpicker" >
                <option value="yes" <?php if($ticket->pp_avail=='yes') echo 'selected'; ?>>Yes</option>
               <option value="no" <?php if($ticket->pp_avail=='no') echo 'selected'; ?> >No</option>
            ...
            <label for="cars"><?=_l('tl_avail')?></label>
               ...
               <select name="tl_avail" id="tl_avail" class="form-control selectpicker" >
                <option value="yes" <?php if($ticket->tl_avail=='yes') echo 'selected'; ?>>Yes</option>
               <option value="no" <?php if($ticket->tl_avail=='no') echo 'selected'; ?> >No</option>
            ...
            <label for="cars"><?=_l('cc_avail')?></label>
               ...
               <select name="cc_avail" id="cc_avail" class="form-control selectpicker" >
                <option value="yes" <?php if($ticket->cc_avail=='yes') echo 'selected'; ?>>Yes</option>
               <option value="no" <?php if($ticket->cc_avail=='no') echo 'selected'; ?> >No</option>
              </select>
            </div>
             </div>
							<div class="col-md-4">
							 <?php echo render_date_input('bus_startdate','bus_startdate',_d($ticket->bus_startdate)); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('sister_deal','sister_deal',$ticket->sister_deal,'text'); ?>
							</div>
									<div class="col-md-4">
								<?php echo render_input('hold_salesperson','hold_salesperson',$ticket->hold_salesperson,'text'); ?>
							</div>
						
							<div class="col-md-4">
								<?php echo render_input('chqhold_amount','chqhold_amount',$ticket->chqhold_amount,'text'); ?>
							</div>
									<div class="col-md-4">
						<div class="form-group">
						<?php echo render_input('sales_month','sales_month',$ticket->sales_month,'text'); ?>
							</div>	
						</div>
						<div class="col-md-4">
								<?php echo render_input('cheque_no','cheque_no',$ticket->cheque_no,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('cheque_bank','cheque_bank',$ticket->cheque_bank,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_date_input('cheque_dt','cheque_dt',_d($ticket->cheque_dt)); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_date_input('newdeposit_dt','newdeposit_dt',_d($ticket->newdeposit_dt)); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('cheque_type','cheque_type',$ticket->cheque_type,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('holdcredit_period','credit_period',$ticket->holdcredit_period,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('actcredit_period','actcredit_period',$ticket->actcredit_period,'text'); ?>
							</div>
								<div class="col-md-4">
								<?php echo render_input('nextpdc','nextpdc',$ticket->nextpdc,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('pdc_inhand','pdc_inhand',$ticket->pdc_inhand,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('out_dues','out_dues',$ticket->out_dues,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('os_salesmonth','os_salesmonth',$ticket->os_salesmonth,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('holdchq_amount','holdchq_amount',$ticket->holdchq_amount,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('no_cheque_return','no_cheque_return',$ticket->no_cheque_return,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('no_cheque_hold','no_cheque_hold',$ticket->no_cheque_hold,'text'); ?>
							</div>
							
							<div class="col-md-8">
								<?php echo render_input('reasonforhold','reasonforhold',$ticket->reasonforhold,'text'); ?>
							</div>
							<div class="col-md-4">
							   <div class="form-group">
               ...
               <select name="holdpolice_civilcase" id="holdpolice_civilcase" class="form-control selectpicker" >
                <option value="yes" <?php if($ticket->holdpolice_civilcase=='yes') echo 'selected'; ?>>Yes</option>
               <option value="no" <?php if($ticket->holdpolice_civilcase=='no') echo 'selected'; ?>>No</option>
							...
							<div class="col-md-4">
								<?php echo render_input('payment_nature','payment_nature',$ticket->payment_nature,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('sales_history','sales_history',$ticket->sales_history,'text'); ?>
							</div>
             		...
             		<?php } ?>
              		<!--  Additional data for Credit Application ------>
              		 	<?php if(($ticket->service==get_option('ticket_creditrevision_service'))){?>
			<div class="row" id="creditapprevision">
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-heading">
					...
					<div class="panel-body">
						...
						<div class="col-md-4">
						<div class="form-group">
						<?php echo render_input('business_type','business_type',$ticket->business_type,'text'); ?>
							</div>	
						</div>
						<div class="col-md-4">
								<?php echo render_input('excredit_days','excredit_days',$ticket->excredit_days,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('excredit_amount','excredit_amount',$ticket->excredit_amount,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('procredit_days','procredit_days',$ticket->procredit_days,'text'); ?>
							</div>
							<div class="col-md-4">
								<?php echo render_input('procredit_amount','procredit_amount',$ticket->procredit_amount,'text'); ?>
							</div>
							 <div class="col-md-4">
                       <div class="form-group">
          
            <label for="cars"><?=_l('bank_statment1')?></label>
  		<?php  $value=(isset($ticket) ? $ticket->bank_stmt : ''); ?>
            ...
            <label for="cars"><?=_l('payment_terms')?></label>
  			<?php  $value=(isset($ticket) ? $ticket->payment_terms : ''); ?>
               <select name="payment_terms" id="payment_terms" class="form-control selectpicker" >
                <option value="yes" <?php if ($value=='yes')echo 'selected'?>>Due Date</option>
               <option value="no" <?php if ($value=='no')echo 'selected'?> >Every Month PDC</option>
							...
							<div class="col-md-4">
								<?php echo render_input('securechq_amount','securechq_amount',$ticket->securechq_amount,'text'); ?>
							</div>
							 <div class="col-md-4">
							              <div class="form-group">
          
            <label for="cars"><?=_l('balance_confirm')?></label>
  				<?php  $value=(isset($ticket) ? $ticket->balance_confirm : ''); ?>
               <select name="balance_confirm" id="balance_confirm" class="form-control selectpicker" >
               ...
               <option value="no" <?php if ($value=='no')echo 'selected'?> >No</option>
                      ...
                      <div class="col-md-12">
								 ...
								 <?php echo render_textarea('year_return_cheque','year_return_cheque',$ticket->year_return_cheque,array('rows'=>2),array(),'',''); ?>
					</div>
  	...
  	<?php  $value=(isset($ticket) ? $ticket->police_civilcase : ''); ?>
  		...
  		<?php  $value=(isset($ticket) ? $ticket->year_payment_default : ''); ?>
               ...
               <option value="no" <?php if ($value=='no')echo 'selected'?>>No</option>
							...
							<div class="col-md-4">
								<?php echo render_input('dealing_customer','dealing_customer',$ticket->dealing_customer,'text'); ?>
							</div>
               ...
               <div class="row">
                ...
                <table class="table table-bordered text-center">  
                  ...
                  <?php if (has_permission('tickets','','edit')){?>   <th style="text-align: center"><?=_l('action')?></th><?php }?>
                     ...
                     <td><?=get_document_type_name($row['document_type'])?></td>
                      <td><?=$row['document_number']; ?></td>
                       <td><?=$row['document_name']; ?></td>
                        ...
                        <?php if (has_permission('tickets','','edit')){?>  <td><a class="btn btn-info mbot25" href="#" onclick="showAjaxModal('<?php echo admin_url();?>tickets/editcredit/<?php echo $row['id']?>');">	<i class="fa fa-pencil"></i></a></td>
                      <?php } ?>
                 ...
                 <?php
						...
						?>
                             ...
                             <?php if (has_permission('tickets','','edit')){?>  <a class="btn btn-info mbot25" href="#" onclick="showAjaxModal('<?php echo admin_url();?>tickets/addcredit/<?php echo $ticket->ticketid?>');">	Add NEW</a> <?php } ?>
                              </div>
                           </div>
                           <hr />
      ...
      <?php if(get_option('enable_legal_request_approval')==1) { ?>   
            <div role="tabpanel" class="tab-pane" id="approval">
               <hr class="no-mtop" />
                     ...
                     <?php if(is_array($ticket->approvals)&& sizeof($ticket->approvals)>0){  ?> 
                       <div class="row">
                 		 <div class="col-md-12">
                        ...
                        <table class="table table-bordered text-center">
                          ...
                          <?php if(!empty($ticket->last_approving)){?>
							
                          <?php if($approval['id']<=$ticket->last_approving){?>
                           <tr>
                              <th>
                                 <div class="col-md-3">
                                    <?=get_approval_heading_name_by_id($approval['approval_heading_id'])?>
                                 ...
                                 <div class="col-md-3 mtop20">
                                    <?php  if($approval['staffid'] != get_staff_user_id() || $approval['approval_status']==3 || $approval['approval_status']==5 || $approval['approval_status']==7){ 
                                 ...
                                 <?php if(($ticket->service==get_option('ticket_creditapplication_service'))|| ($ticket->service==get_option('ticket_creditrevision_service'))){?>
                                  <div class="col-md-3">
								  </div>
								  <div class="col-md-3"></div>
										<div class="col-md-3">
										<?php  if(is_admin()){
											 $attr12=array('rows'=>2,'placeholder'=>'Credit','onblur'=>'update_approval_credits(this,'.$approval['id'].')');}else if($approval['staffid'] != get_staff_user_id()|| $approval['approval_status']==3 || $approval['approval_status']==5 || $approval['approval_status']==7 ){ 
											  $attr12=array('rows'=>2,'placeholder'=>'Credit','disabled'=>'disabled'); } else{
                                 $attr12=array('rows'=>2,'placeholder'=>'Credit','onblur'=>'update_approval_credits(this,'.$approval['id'].')');}
                                          ?>
								<?php echo render_input('credit_period','credit_period',$approval['credit_period'],'text',$attr12); ?>
								
							</div>
                                <div class="col-md-3">
                               <?php  if(is_admin()){
											  $attr13=array('placeholder'=>'Credit','onblur'=>'update_approval_creditamounts(this,'.$approval['id'].')');
										  }else if($approval['staffid'] != get_staff_user_id()|| $approval['approval_status']==3 || $approval['approval_status']==5 || $approval['approval_status']==7 ){ 
                                        $attr13=array('placeholder'=>'Credit','disabled'=>'disabled'); } else{
                                 $attr13=array('placeholder'=>'Credit','onblur'=>'update_approval_creditamounts(this,'.$approval['id'].')');}
                                          ?>
								<?php echo render_input('credit_amount','credit_amount',$approval['credit_amount'],'text',$attr13); ?>
							</div>	
								  <?php
										  }
								  ?>
                           ...
                           <?php } } ?>
                                                ...
                                                <?php if(($ticket->service==get_option('ticket_creditapplication_service'))){?>
<!--  Additional data for Credit Application Approval------>

		<div class="row " id="branchapproval">
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-heading">
						<h4><?php echo _l('gen_comments_by_branchmanager'); ?></h4>
					</div>
					<div class="panel-body">
					                          	<div class="row">
						<div class="col-md-4">
						<div class="form-group">
						 <?php  $value=( isset($branchapproval) ? $branchapproval->id : ''); ?>
						<input type="hidden" name="id" value="<?=$value?>"  />
						 <?php  $value=( isset($branchapproval) ? $branchapproval->payment_type : ''); ?>
						<?php 
	    echo render_select('payment_type',$credit_payment,array('id','name'),'ticket_paymenttype',$value,array());
                              ?>
							</div>	
						</div>
						<div class="col-md-4">
							  <?php  $value=( isset($branchapproval) ? $branchapproval->cheque_type : ''); ?>
								<?php 
	    echo render_select('cheque_type',$credit_cheque,array('id','name'),'ticket_creditcheque',$value,array());
                              ?>
							</div>
								
						
					<div class="col-md-4" style="margin-top: 25px;">
                              <button type="button"  class="btn btn-info save_branch_approval_ticket"><?php echo _l('submit'); ?></button>
                           </div>
...
<!--  Additional data for Credit Application Approval------>
		...
		<div class="row " id="creditapproval">
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-heading">
						<h4><?php echo _l('creditappadditional_info'); ?></h4>
					</div>
					<div class="panel-body">
					                          	<div class="row">
					   <div class="col-md-4">
							 <?php  $value=( isset($legalapproval) ? $legalapproval->branch1 : ''); ?>
								<?php echo render_input('branch1','branch_division',$value,'text'); ?>
						</div>
						<div class="col-md-4">
							 <?php  $value=( isset($legalapproval) ? $legalapproval->branch2 : ''); ?>
								<?php echo render_input('branch2','branch_division',$value,'text'); ?>
						</div>
						<div class="col-md-4">
							 <?php  $value=( isset($legalapproval) ? $legalapproval->branch3 : ''); ?>
								<?php echo render_input('branch3','branch_division',$value,'text'); ?>
						</div>
						<div class="col-md-4">
						<div class="form-group">
						 <?php  $value=( isset($legalapproval) ? $legalapproval->id : ''); ?>
						<input type="hidden" name="id" value="<?=$value?>"  />
						 <?php  $value=( isset($legalapproval) ? $legalapproval->btcredit_limit : ''); ?>
						<?php echo render_input('btcredit_limit','btcredit_limit',$value,'text'); ?>
							</div>	
						</div>
						<div class="col-md-4">
							 <?php  $value=( isset($legalapproval) ? $legalapproval->bagcredit_limit : ''); ?>
								<?php echo render_input('bagcredit_limit','bagcredit_limit',$value,'text'); ?>
							</div>
							<div class="col-md-4">
							 <?php  $value=( isset($legalapproval) ? $legalapproval->bmccredit_limit : ''); ?>
								<?php echo render_input('bmccredit_limit','bmccredit_limit',$value,'text'); ?>
							</div>
							<div class="col-md-4">
							 <?php  $value=( isset($legalapproval) ? $legalapproval->btcredit_days : ''); ?>
								<?php echo render_input('btcredit_days','btcredit_days',$value,'text'); ?>
							</div>
							<div class="col-md-4">
							 <?php  $value=( isset($legalapproval) ? $legalapproval->bagcredit_days : ''); ?>
								<?php echo render_input('bagcredit_days','bagcredit_days',$value,'text'); ?>
							</div>
							<div class="col-md-4">
							 <?php  $value=( isset($legalapproval) ? $legalapproval->bmccredit_days : ''); ?>
								<?php echo render_input('bmccredit_days','bmccredit_days',$value,'text'); ?>
							</div>
			...
			<div class="col-md-12 text-center">
                              <button type="button"  class="btn btn-info save_legal_approval_ticket"><?php echo _l('submit'); ?></button>
                           </div>
          ...
          <?php } else{  ?>
                    ...
                    // $approval_types = get_approval_types($ticket->service_slug,$ticket->service); 
				//  $approval_types = get_approval_types('ticket',$ticket->service); 
                     $approvalid= get_firstapproval_name($ticket->service_slug,$ticket->service);?>
                     <?php // if(!get_ticket_count($ticket->ticketid,$service_ticket)){ ?> 
                     <a class="btn btn-info" href="#" onclick="load_ticketapproval_modal('<?php echo admin_url('tickets/update_single_ticket_approvals?rel_name='.$service_ticket.'&rel_id='.$ticket->ticketid); ?>');return false;"><?=_l('new_approval')?></a>
                      <?php // } ?>
                      </div>
				</div>
   ...
   <div class="col-md-9">
      ...
      <?php if(count($ticket->attachments) > 0){
         ...
         if(is_admin() || (!is_admin() && get_option('allow_non_admin_staff_to_delete_ticket_attachments') == '1') || (has_permission('tickets','','delete'))){
      ...
      <div class="panel-body <?php if($reply['admin'] == NULL){echo 'client-reply';} ?>">
         <div class="row">
            <div class="col-md-3 border-right ticket-submitter-info">
              ...
              <hr />
             <?php   if(is_admin() || (!is_admin() && get_option('allow_non_admin_staff_to_delete_ticket_attachments') == '1') || (has_permission('tickets','','delete'))){?>
...
<script>
  ...
  if (typeof(csrfData) !== 'undefined') {
    ...
    setInterval(function() {
        $.ajax({
            url: "<?= admin_url('tickets/get_interval/'.$ticket->ticketid) ?>",
            type: "GET",
            data:data,
    ...
    }, 60000); // Calls the function every 60 seconds
</script>
<script>
   $(function(){
      $.ajax({
...
<script type="text/javascript">
       ...
       $.post(admin_url + 'tickets/update_single_ticket_approvals', data).done(function(response) {
            ...
            if (response.success == true) {
				 window.location.reload(); 
				   $('.save_changes_approval_ticket').prop('disabled', false);
                            
            }
        });
    });
	$('.save_branch_approval_ticket').on('click', function(e) {
		
        e.preventDefault();
	  //  $('.save_changes_approval_ticket').prop('disabled', true);
        var data={};
        data = $('#branchapproval *').serialize();
        data += '&ticketid=' + $('input[name="ticketid"]').val();
        if (typeof(csrfData) !== 'undefined') {
            data += '&' + csrfData['token_name'] + '=' + csrfData['hash'];
        }
       $.post(admin_url + 'tickets/save_single_ticket_branchapprovals', data).done(function(response) {
            response = JSON.parse(response);
            console.log(response);
            if (response.success == true) {
				 window.location.reload(); 
   ...
   $('.save_legal_approval_ticket').on('click', function(e) {
      
        e.preventDefault();
     //  $('.save_changes_approval_ticket').prop('disabled', true);
        var data={};
        data = $('#creditapproval *').serialize();
        data += '&ticketid=' + $('input[name="ticketid"]').val();
        if (typeof(csrfData) !== 'undefined') {
            data += '&' + csrfData['token_name'] + '=' + csrfData['hash'];
        }
       $.post(admin_url + 'tickets/save_single_ticket_legalapprovals', data).done(function(response) {
            response = JSON.parse(response);
            console.log(response);
            if (response.success == true) {
             window.location.reload(); 
   ...
   function update_approval_status(th,id) {
	...
	function update_approval_credits(th,id) {
      var credits = $(th).val();
      var data={"credit_period" : credits};
      $.post(admin_url + 'tickets/change_approval_credits_ajax/'+id, data).done(function(response) {
         response = JSON.parse(response);
         alert_float(response.alert, response.message);
      });
   } 
	function update_approval_creditamounts(th,id) {
      var credits = $(th).val();
      var data={"credit_amount" : credits};
      $.post(admin_url + 'tickets/change_approval_creditamounts_ajax/'+id, data).done(function(response) {
         response = JSON.parse(response);
         alert_float(response.alert, response.message);
      });
   } 
...
<script type="text/javascript">
    $(document).ready(function(){      
      var i=1; 
		...
		var cd=1;
		var ci=1;
		var cci=1;var cp=1;var ss=1;var gc=1;var gcc=1;var oc=1;var lc=1;
...
<script type="text/javascript">
		function load_ticketapproval_modal(url)
	{ 
			url = typeof (url) != 'undefined' ? url : admin_url + 'tickets/update_single_ticket_approvals';
   ...
   $('#amount_related').change(function(){
      ...
      function change_reassign_status(th,note_id){
    if (note_id != '') {
        var status = $(th).val();
        $.post(admin_url + 'tickets/update_reassign_status', {
            ...
            if($.fn.DataTable.isDataTable('.table-reassign-list')){
               //  $('.table-reassign-list').DataTable().ajax.reload();
            }
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="width: 800px; margin-left: -150px;">
                ...
                <div class="modal-header" style="background:#4C74E3;">
                    ...
                    <h4 class="modal-title"><?php echo "Credit Attachment"; ?></h4>
                </div>
