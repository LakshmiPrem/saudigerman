...
?>
             ...
             <td><?php echo get_reassign_satatus_by_id($reassign['status']); ?><br> <?php
             if(get_staff_user_id()==$reassign['assigned']||get_staff_user_id()==$reassign['assigned_by']||is_admin()) {
             echo render_select('reassign_status',$statuses_reassign,array('ticketstatusid','name'),'',$reassign['status'],['onchange'=>"change_reassign_status(this,'".$reassign['id']."');"],[],'','',false,false);}?></td>  
