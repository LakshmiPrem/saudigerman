                  ...
                  <div class="horizontal-scrollable-tabs">
                     ...
                     <div class="horizontal-tabs">
                        <ul class="nav nav-tabs no-margin nav-tabs-horizontal" role="tablist">
                            <li role="presentation" class="<?php if($ticket->service ==1 && !isset($confirmapproval)){ if(!$this->session->flashdata('active_tab')){echo ' active';}} ?>">
                              ...
                              <li role="presentation" class="<?php if($ticket->service ==2 && !isset($confirmapproval)){ if(!$this->session->flashdata('active_tab') ){echo ' active';}} ?>">
                             ...
                             <li role="presentation" class="<?php if($ticket->service !=1 && $ticket->service !=2){ if(!$this->session->flashdata('active_tab')&& !isset($confirmapproval)){echo 'active';}} ?>" >
         ...
         <div class="panel_s">
            <div class="panel-body">
               ...
               <div class="tab-content">
                                         <div role="tabpanel" class="tab-pane <?php if($ticket->service ==1 && !isset($confirmapproval)){ if(!$this->session->flashdata('active_tab')){echo 'active';}} ?>" id="civilrequest">
                  <hr class="no-mtop" />
                  <div class="row">
      ...
      <div class="clearfix"></div><br>
               ...
               <div class="row">
                  <div class="col-md-12 text-center">
                     <hr />
                     <?php 
					  if(get_approvalticket_record_status($ticket->ticketid,$service)){?>
            ...
            <!-- ###Police Request -->
             <div role="tabpanel" class="tab-pane <?php if($ticket->service ==2 && !isset($confirmapproval)){ if(!$this->session->flashdata('active_tab')){echo 'active';}} ?>" id="policerequest">
                  <hr class="no-mtop" />
	...
	if(isset($police)&& ($police->owner_detail!='')){
      ...
      <div class="clearfix"></div><br>
             ...
             <?php echo form_close(); ?>
               ...
               <div role="tabpanel" class="tab-pane <?php if($ticket->service !=1 && $ticket->service !=2 ){ if(!$this->session->flashdata('active_tab')&& !isset($confirmapproval)){echo 'active';}} ?>"  id="settings">
                  <hr class="no-mtop" />
                  <div class="col-md-12">
	    ...
	    echo render_select('service',$services,array('serviceid','name'),'ticket_settings_service',$ticket->service,array('disabled'=>true));
                         ...
                         <?php echo form_hidden('service',$ticket->service); ?>
                     ...
                     <div class="row">
                        <div class="col-md-<?php if(get_option('services') == 1){ echo 6; }else{echo 12;} ?>">
                     	 ...
                     	 <?php echo render_input('file_amount','amt_case',$ticket->file_amount,'text'); ?>
                    						 ...
                    						 <?php if($ticket->service=='9'){?>
                     						 <div class="row" id="contractapp">

            <div class="col-md-6">
               <?php $value = (isset($ticket) ? _d($ticket->contractstart) : _d(date('Y-m-d'))); ?>
               <?php echo render_date_input('contractstart','contract_start_date',$value); ?>
            </div>
            <div class="col-md-6">
               <?php $value = (isset($ticket) ? _d($ticket->contractend) : ''); ?>
               <?php echo render_date_input('contractend','ticket_end_date',$value); ?>
            </div>
             <div class="col-md-6">
              <?php
					 $selected = (isset($ticket) ? $ticket->contract_type : '');														 
              ...
              <div class="col-md-6">
              <?php $value=(isset($ticket) ? $ticket->contract_name: '');?>
              
								<?php echo render_input('contract_name','contract_name',$value,'text'); ?>
						</div>
         	  <div class="col-md-12">
         	   <?php $value=(isset($ticket) ? $ticket->gen_reason: '');?>
          	 <?php echo render_textarea('gen_reason','reason',$value,array('rows'=>2),array(),'',''); ?>
                    ...
                    <?php }?>
                     <div class="form-group select-placeholder projects-wrapper<?php if($ticket->userid == 0){echo ' hide';} ?>">
                        ...
                        <div id="project_ajax_search_wrapper">
                          ...
                          <?php echo render_textarea('oth_comments','oth_comments',$ticket->oth_comments,array('rows'=>4),array(),'',''); ?>		
					...
					$service='general';
						...
						elseif($ticket->service==7)
							$service='closure';
							 ...
							 $service='general';
                 //    $approval_types = get_approval_types($service,$ticket->service); 
                 //    $approvalid= get_firstapproval_name($service,$ticket->service);
						 ?>
                      <?php if(!get_ticket_count($ticket->ticketid,$service)){ ?> 
                     <a class="btn btn-info" href="#" onclick="load_approval_modal('<?php echo admin_url('approval/approvals?rel_name='.$service.'&rel_id='.$ticket->ticketid); ?>');return false;">New Approval</a>
                      <?php } ?>
                  </div>
...
<script type="text/javascript">
	init_approval_table('<?php echo $service; ?>',<?php echo $ticket->ticketid; ?>);
</script>
<!--<script type="text/javascript">
