             <div class="row ">
                   <div class="col-md-12">
                   <?php echo form_open_multipart('admin/tickets/editcreditapp/',array('id'=>'creditdoc-form','autocomplete'=>'off')); ?>
                    <div class="col-md-12">
                         <!-- // For email exist check -->
                      
                          <?php echo form_hidden('ticketid',$ticketid); ?>
                     ...
                     <?php } ?>
                        ...
                        <?php echo render_input( 'document_number', 'document_number',''); ?>
                       
                        <?php echo render_input( 'document_name', 'document_name',''); ?>
                     ...
                     <?php } ?>
                       ...
                       <input type="date" name="expiry_date" placeholder="Expiry Date" class="form-control" value=""  />
