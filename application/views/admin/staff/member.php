               ...
               <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                     ...
                     <div class="form-group hide">
                       ...
                       <div class="form-group hide">
                        <label for="hourly_rate"><?php echo _l('staff_hourly_cost'); ?></label>
                        <div class="input-group">
                           <input type="number" name="hourly_cost" value="<?php if(isset($member)){echo $member->hourly_cost;} else {echo 0;} ?>" id="hourly_cost" class="form-control">
                           <span class="input-group-addon">
                           <?php echo $base_currency->symbol; ?>
                           </span>
                        </div>
                        <?php $value = (isset($member) ? $member->referal_incentive : ''); ?>
                     <?php echo render_input('referal_incentive','referal_incentive',$value); ?>
                     </div>
                     

                     <?php $selected = (isset($member) ? $member->designation : ''); 
                     echo render_select_with_input_group('designation',$designations,array('id','name'),'designation',$selected,'<a href="#" onclick="new_designation();return false;"><i class="fa fa-plus"></i></a>'); ?>

                     <?php $value = (isset($member) ? $member->intitial : ''); ?>
                     <?php echo render_input('intitial','intitial',$value); ?>

                     <?php $value = (isset($member) ? $member->place_of_work : ''); ?>
                     <?php echo render_input('place_of_work','place_of_work',$value); ?>
                     ...
                     <?php echo render_input('salary','salary',$value); ?>
                     </div>
                     <div class="form-group hide">
                     ...
                     <?php if((isset($member) && $member->esignature == NULL) || !isset($member)){ ?>
                        <div class="form-group">
                           <label for="esignature" class="e-signature"><?php echo _l('digital_signature'); ?></label>
                           <input type="file" name="esignature" class="form-control" id="esignature">
                        </div>
                     <?php } ?>
                     <?php if(isset($member) && $member->esignature != NULL){ ?>
                        <div class="form-group">
                           <div class="row">
                              <div class="form-group">
                                 <label for="esignature" class="e-signature"><?php echo _l('digital_signature'); ?></label>
                              ...
                              <div class="col-md-9">
                              <?php $imagePath = base_url('uploads/esignature/'.$member->staffid.'/'.$member->esignature)?>
                                 <img src="<?php echo $imagePath;?>" widht="100px" height="100px">
                                 
                              </div>
                              <div class="col-md-3 text-right">
                                 <a href="<?php echo admin_url('staff/remove_digital_signature/'.$member->staffid); ?>"><i class="fa fa-remove"></i></a>
                              </div>
                           </div>
                        </div>
                     <?php } ?>
                        ...
                        <div class="col-md-12">
                           ...
                           <?php } ?>
                            ...
                            <div class="checkbox checkbox-primary">
                              <?php
                                 $is_lawyer = '';
								if(isset($lawyer) && $$lawyer=='y')
									 $is_lawyer = 'checked';
                                 if(isset($member)) {
                                  if($member->is_lawyer == 1){
                                   $is_lawyer = 'checked';
                                 }
                                 }
                                 ?>
                              <input type="checkbox" name="is_lawyer" id="is_lawyer" <?php echo $is_lawyer; ?> value="1">
                              <label for="is_lawyer"><?php echo _l('is_lawyer'); ?></label>
                           </div>
                           ...
                           <div class="checkbox checkbox-primary">
                              <?php
                                 $is_approver = '';
                                 if(isset($member)) {
                                  if($member->is_approver == 1){
                                   $is_approver = 'checked';
                                 }
                                 }
                                 ?>
                              <input type="checkbox" name="is_approver" id="is_approver" <?php echo $is_approver; ?> value="1">
                              <label for="is_approver"><?php echo _l('is_approver'); ?></label>
                           </div>
                           <div class="checkbox checkbox-primary">
                              <?php
                                 $is_stamper = '';
                                 if(isset($member)) {
                                  if($member->is_stamper == 1){
                                   $is_stamper = 'checked';
                                 }
                                 }
                                 ?>
                              <input type="checkbox" name="is_stamper" id="is_stamper" <?php echo $is_stamper; ?> value="1">
                              <label for="is_stamper"><?php echo _l('is_stamper'); ?></label>
                           </div>
                        </div>
                     </div>
...
<?php $this->load->view('admin/staff/designation'); ?>
