...
<body <?php echo admin_body_class(isset($bodyclass) ? $bodyclass.' hide-sidebar ' : ' hide-sidebar '); ?><?php if($isRTL === 'true'){ echo 'dir="rtl"';}; ?>  style="height: auto !important; max-height: 2000px !important;">
