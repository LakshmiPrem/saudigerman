...
<div class="modal fade email-template" data-editor-id=".<?php echo 'tinymce-'.$contract->id; ?>" id="contract_send_for_approval" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <?php
                            $approval_template_array =  prepare_mail_preview_data('contract_approval', $contract->client);
                            ...
                            echo render_select('sent_to[]',$contacts,array('staffid','email','firstname,lastname'),'contract_send_to',$selected,array('multiple'=>true),array(),'','',false);
