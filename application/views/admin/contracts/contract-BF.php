            ...
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <?php if(get_option('enable_legal_request')==1) { ?>
                    <?php $selected = (isset($contract) ? $contract->ticketid : ''); ?>
           ...
           <div class="col-md-12">
			 ...
			 <div class="col-md-6">
			   <?php $selected = (isset($contract) ? $contract->status : '2'); ?>
                      <?php echo render_select('status',$statuses,array('ticketstatusid','name'),'status',$selected,array(),array(),'','',false); ?>
			 </div>
			  <div class="col-md-6">
         ...
         <div class="panel-body">
          ...
          ?>
               ...
               <?php if($contract->other_party!=0){?>
                        <a href="<?php echo admin_url('opposite_parties/opposite_party/'.$contract->project_id); ?>" class="btn btn-info pull-right" >
                  <?php echo _l('otherparty'); ?>
               </a>
               <?php } ?></h4><br> 

               <?php if($contract->project_id!=0){?>
                        <a href="<?php echo admin_url('projects/view/'.$contract->project_id); ?>" class="btn btn-info pull-right" >
                  <?php echo _l('goback_project'); ?>
               </a>
               <?php } ?></h4><br>

			 <span class="pull-right" style="font-size:14px;font-weight: bold"> <?php echo 'Prepared By : '. get_staff_full_name($contract->addedfrom); ?></span>
            <a href="<?php echo site_url('contract/'.$contract->id.'/'.$contract->hash); ?>" target="_blank">
               <?php echo _l('view_contract'); ?>
            </a>
          
                <?php if($contract->ticketid!=0){?>
              <a href="<?php echo admin_url('tickets/ticket/'.$contract->ticketid); ?>" target="_blank" class="pull-right" >
            ...
            <div class="horizontal-scrollable-tabs preview-tabs-top">
               ...
               <div class="horizontal-tabs">
                  ...
                  <!--------------activity_log-------------------------------->
                  <li role="presentation" class="tab-separator">
                  <a href="#tab_activitylog" onclick="get_templates('contracts', <?php echo $contract->id ?>); return false" aria-controls="tab_activitylog" role="tab" data-toggle="tab">
                  ...
                  <div class="row">
                                    ...
                                    <!------------------signed contract--------------------------------------------------------------->
                                                      <?php if(isset($contract) && $contract->signed_contract_filename == '' ){ ?>
                                                         <a href="#" data-toggle="tooltip" data-title="<?php echo _l('upload_signedcontract'); ?>" class="btn btn-info" onclick="upload_signed_contractfile(<?php echo $contract->id; ?>); return false;">
                                                         <i class="fa fa-upload"></i>
                                                      ...
                                                      <?php }else{
                                                         ...
                                                         if(file_exists($file_path.$contract->signed_contract_filename)){?>
                                                            <a href="#" onclick="delete_signed_contract_document(<?php echo $contract->id; ?>); return false;" class="btn btn-danger mleft10 " id="contact-agreeremove-img"><i class="fa fa-remove"></i><?=_l('change_contract')?></a>
                                                            <a download href="<?php echo $path1.$contract->signed_contract_filename; ?>"  class="btn btn-success btn-with-tooltip mright5" data-toggle="tooltip" download title="<?php echo _l('signed_contract'); ?>" data-placement="bottom"><i class="fa fa-file-word-o" aria-hidden="true"></i></a>
                                                         <?php } 
                                                      } ?>
                                    <!-------------------signed contract-------------------------------------------------------------->
                                             ...
                                             <!-- <a href="#" class="btn btn-warning" data-target="#contract_send_for_approval" data-toggle="modal"><span class="btn-with-tooltip" data-toggle="tooltip" data-title="<?php echo _l('contract_send_for_approval'); ?>" data-placement="bottom">
                                                <i class="fa fa-envelope" style="color:white;"></i></span>
                                                   ...
                                                   <a target="_blank" href="<?php echo admin_url('contracts/legalcontract_approval/'.$contract->id); ?>" class="btn btn-default btn-with-tooltip" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Download Contract Approval"> <i class="fa fa-file-pdf-o"></i> Contract Approval </a>
                                             <div class="btn-group">
   ...
   <div class="display-block">
      <div class="media-body">
         <div class="display-block">
            ...
            <hr class="hr-10" />
              <?php if($renewal['renewed_by_staff_id'] == get_staff_user_id() || is_admin()){ ?>
                <a  href="<?php echo site_url('download/downloadfile/').$renewal['contractid'].'/'.$renewal['id']; ?>" class="pull-right text-info" title="Download Renewal" ><i class="fa fa-download"></i></a>
