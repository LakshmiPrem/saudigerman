   ...
   <div class="col-md-12">
      <div class="panel_s">
                  ...
                  <ul class="nav nav-tabs tabs-in-body-no-margin contract-tab nav-tabs-horizontal mbot15" role="tablist">
                     <li role="presentation" class="<?php if(!$this->input->get('tab') || $this->input->get('tab') == 'tab_content'){echo 'active';} ?>">
                        <a href="#tab_content" aria-controls="tab_content" role="tab" data-toggle="tab">
                           <?php echo _l('contract_contract'); ?>
                        </a>
                     </li>
					 <li role="presentation" class="<?php if($this->input->get('tab') == 'tab_contract'){echo 'active';} ?> <?php if(empty($contract->contract_template_id)) echo 'hide';?>">
         ...
         ?>
           ...
           <div class="col-md-4 <?php if(isset($contract) && !empty($contract->contract_template_id)) echo 'hide';?>" id="div_template" <?php if(isset($contract)){?> style="pointer-events: none;"<?php }?>>
             <?php 
                           
                $selected = (isset($contact) ? $contract->contract_template_id : '');?>
	...
	<!-----------tab contract------------------------------------------------------------>
      <div role="tabpanel" class="tab-pane<?php if($this->input->get('tab') == 'tab_contract'){echo ' active';} ?> <?php if(empty($contract->contract_template_id)) echo 'hide';?>" id="tab_contract">
...
<?php echo form_open(admin_url('contracts/save_risk_checklist/'.$contract->id)); ?>
    <?php
                        ...
                        echo render_select('risklist[]',$risklists,array('id','name'),'risk_checklist',$selected,array('multiple'=>true,'data-actions-box'=>true),array(),'','',false);
                        ?>
