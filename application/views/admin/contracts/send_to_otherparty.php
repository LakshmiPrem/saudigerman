...
<div class="modal fade email-template" data-editor-id=".<?php echo 'tinymce-'.$contract->id; ?>" id="contract_send_to_otherparty_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <?php echo form_open('admin/contracts/send_to_email_otherparty/'.$contract->id); ?>
                ...
                <h4 class="modal-title" id="myModalLabel">
                    ...
                    <?php 
                        if ($contract->type == 'contracts') {
                            echo _l('contract_send_to_otherparty_modal_heading');
                        } else {
                            echo _l('po_send_to_otherparty_modal_heading'); // fallback
                        }
                    ?>
                </h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            $contacts = $this->contracts_model->get_contracts_of_oppositeparty($contract->id);
                        ...
                        <?php echo render_input('secondary_email','secondary_email'); ?>
                        <?php //echo render_input('cc','CC'); ?>
                        <?php echo render_select('cc[]',$staffs,array('staffid', 'firstname', 'lastname'),'CC','',array('multiple' => true)); ?>
                        ...
                        <hr />
                        <?php  
                        echo render_textarea('email_template_custom','',$template1['template']->message,array(),array(),'','tinymce-'.$contract->id); ?>
