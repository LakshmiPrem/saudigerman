      ...
      <div class="row">
         <div class="col-md-12">
            <div class="panel_s">
               <div class="panel-body">
                  <div class="row">
                     <div class="col-md-8 border-right">
                      <h4 class="no-margin font-medium"><i class="fa fa-puzzle-piece" aria-hidden="true"></i> <?php echo _l('pb_report'); ?></h4>
               ...
               <?php $this->load->view('admin/reports/includes/pb_report'); ?>
               </div>
            </div>
         </div>
      </div>
...
<?php init_tail(); ?>
<?php $this->load->view('admin/reports/includes/pb_js'); ?>
<script type="text/javascript">
  init_report('PB Report','invoices-report');
</script>
</body>
</html>
