      ...
      <div class="row">
         <div class="col-md-12">
            <div class="panel_s">
               <div class="panel-body">
                  <div class="row">
                     <div class="col-md-4 border-right">
                      ...
                      <hr class="hr-10" />
                      <p>
                        <a href="#" class="font-medium " onclick="init_report(this,'referrals-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('referral_report'); ?></a>
                      </p>
               ...
               <?php $this->load->view('admin/reports/includes/sales_receivables'); ?>
               <?php $this->load->view('admin/reports/includes/sales_referrals'); ?>
               </div>
            </div>
         </div>
      </div>
