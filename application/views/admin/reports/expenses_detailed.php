    ...
    <div class="content">
        <div class="row">
            <div class="col-md-12">
			 ...
			 <div class="col-md-3">
				  <?php 
                                    echo render_select('project_id',$cases,array('id','name'),'projects');?>
                                 
                                </div>
                                <div class="col-md-3">
                                    <?php 
                                    echo render_select('lawyer_id',$external_lawyers,array('staffid',array('firstname','lastname')),'law_firm');?>
                                </div>
        </div>
    </div>
       ...
       <thead>
           <tr>
            ...
            <!--   <th><?php echo _l('report_invoice_amount_with_tax'); ?></th>-->
               <th><?php echo _l('expenses_list_refundable'); ?></th>
...
<script>
    $(function(){
       ...
       Expenses_ServerParams['report_to'] = '[name="report-to"]';
		 Expenses_ServerParams['project_id'] = '[name="project_id"]';
       Expenses_ServerParams['lawyer_id'] = '[name="lawyer_id"]';
	...
	$('select[name="project_id"]').on('change',function(){
       ...
       $('select[name="lawyer_id"]').on('change',function(){
        $('.table-expenses').DataTable().ajax.reload();
       }); 
   })
