    <div id="matter-transfercase" class="hide">
       <div class="row">
         
             <div class="col-md-3">
            <div class="form-group">
               <label for="sale_agent_invoices"><?php echo _l('clients'); ?></label>
                <select id="clientid" name="clientid15" data-live-search="true" data-width="100%" class="ajax-search" data-none-selected-text="<?php echo _l('clients'); ?>">         
               </select>
            </div>
         </div>
        
       <div class="col-md-3">
            <?php echo render_select('country_id15',$countries,array('country_id','short_name'),'country'); ?>
         </div>
          <div class="col-md-3">
            <label for="status"><?php echo _l('status'); ?></label>
           <select class="form-control selectpicker" id="p_status15" name="p_status15" >
         ...
         <table class="table table-matter-transfercase-report scroll-responsive">
            <thead>
               <tr>
