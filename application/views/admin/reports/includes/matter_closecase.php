    <div id="matter-closecase" class="hide">
       <div class="row">
         
             <div class="col-md-4">
            <div class="form-group">
               <label for="sale_agent_invoices"><?php echo _l('clients'); ?></label>
                <select id="clientid" name="clientid8" data-live-search="true" data-width="100%" class="ajax-search" data-none-selected-text="<?php echo _l('clients'); ?>">         
               </select>
            </div>
         </div>
         ...
         <table class="table table-matter-closecase-report scroll-responsive">
            <thead>
              <tr>
                 ...
                 <th><?php echo _l('claiming_amount'); ?></th>
                   <th><?php echo _l('court_expenses'); ?></th>
                    ...
                    <th><?php echo _l('reason_for_close'); ?></th>
