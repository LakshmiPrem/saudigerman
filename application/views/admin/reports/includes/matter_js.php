<script> 
 ...
 var report_collective_filter=$('#collection_filter');
 ...
 var report_matter_litigation_update = $('#matter-litigation-update-report');
...
var report_matter_individualcase = $('#matter-individualcase-report');
 ...
 var report_matter_age_wise = $('#matter-age-wise-report');
	...
	var report_matter_handover = $('#matter-handover');
	var report_matter_transfercase = $('#matter-transfercase');
	var report_matter_companycase = $('#matter-companycase');
	var report_legalrequests = $('#legalrequests-report');
  var report_agreements_receivable = $('#receivable-agreements-report');
  var report_agreements_payable = $('#payable-agreements-report');
	var report_agreements_signed = $('#signed-agreements-report');
 ...
 var fnServerParams = {
   ...
   'clientid2':'[name="clientid2"]',
	 ...
	 'clientid28':'[name="clientid28"]',
   'lawyerid2':'[name="lawyerid2"]',
	 'lawyerid28':'[name="lawyerid28"]',
	 'lawyerid29':'[name="lawyerid29"]',
  ...
  'clientid3':'[name="clientid3"]',
   ...
   'opposite_party':'[name="opposite_party"]' ,
	 ...
	 'country_id22':'[name="country_id22"]',
	 'clientid22':'[name="clientid22"]',
	  'p_status22' : '[name="p_status22"]',
	 'clientid221':'[name="clientid22"]',
	 'contract_type':'[name="contract_type"]',
	 'c_status':'[name="c_status"]',
	 'clientid23':'[name="clientid23"]',
	 'service_type':'[name="service_type"]',
	 't_status':'[name="t_status"]',
	 'case_type1':'[name="case_type1"]',
	 'case_type11':'[name="case_type11"]',
   'contract_typerec':'[name="contract_typerec"]',
   'c_statusrec':'[name="c_statusrec"]',
   'clientid22rec':'[name="clientid22rec"]',
	 'contract_typepay':'[name="contract_typepay"]',
   'c_statuspay':'[name="c_statuspay"]',
   'clientid22pay':'[name="clientid22pay"]',
    'contract_typesign':'[name="contract_typesign"]',
   'c_statussign':'[name="c_statussign"]',
   'clientid22sign':'[name="clientid22sign"]',

 }
 $(function() {
    $('select[name="currency"],select[name="invoice_status"],select[name="estimate_status"],select[name="sale_agent_invoices"],select[name="sale_agent_items"],select[name="sale_agent_estimates"],select[name="payments_years"],select[name="proposals_sale_agents"],select[name="proposal_status"],select[name="credit_note_status"],select[name="client"],select[name="proposal_fee_status"],select[name="clientid2"],select[name="lawyerid2"],select[name="lawyerid3"],select[name="lawyerid2"],select[name="lawyerid3"],select[name="hearing_type"],select[name="nature_type"],select[name="case_id"],select[name="case_id1"],select[name="clientid3"],select[name="clientid4"],select[name="clientid5"],select[name="clientid6"],select[name="clientid9"],select[name="clientid10"],select[name="clientid12"],select[name="clientid11"],select[name="clientid31"],select[name="clientid32"],[name="clientid7"],[name="clientid8"],[name="clientid13"],[name="clientid14"],[name="clientid28"],[name="case_nature"],[name="document_type"],[name="p_status"],[name="p_status11"],[name="p_status31"],[name="country_id"],[name="p_status15"],[name="country_id15"],[name="country_id22"],[name="clientid22"],[name="clientid15"],[name="p_status32"],[name="country_id1"],[name="lawyerid35"],[name="case_type"],[name="case_type11"],[name="clientid27"],select[name="lawyerid24"],select[name="lawyerid25"],[name="p_status22"],[name="p_status2"],select[name="lawyerid4"],select[name="lawyerid28"],select[name="lawyerid29"],select[name="lawyerid5"],select[name="lawyerid15"],[name="case_type1"],[name="a_status"],[name="a_status1"],[name="a_status2"],[name="opposite_party"],[name="client_status"],[name="p_status1"],[name="c_status"],[name="c_statuspay"],[name="c_statusrec"],[name="t_status"],[name="service_type"],[name="clientid23"],[name="clientid221"],[name="a_status1"],[name="a_status2"],[name="opposite_party"],[name="client_status"],[name="clientid22rec"],[name="clientid22pay"],[name="contract_type"],[name="contract_typerec"],[name="contract_typepay"],[name="clientid22sign"],[name="contract_typesign"],[name="c_statussign"]').on('change', function() {
     gen_reports();
   });
 ...
 function init_report(e, type) {
  ...
  report_matter_legalaction.addClass('hide');
   ...
   report_matter_litigation_update.addClass('hide');
   ...
   report_matter_verification.addClass('hide');
	 ...
	 report_matter_companycase.addClass('hide');
	  report_matter_handover.addClass('hide');
	 report_legalrequests.addClass('hide');
	report_agreements_payable.addClass('hide');
  report_agreements_receivable.addClass('hide');
 report_agreements_signed.addClass('hide');
   ...
   // Clear custom date picker
      ...
      if (type == 'matter-clients-report') {
       ...
       }else if (type == 'matter-companycase-report') {
         report_matter_companycase.removeClass('hide');
       }else if (type == 'matter-handover-report') {
         report_matter_handover.removeClass('hide');
       }else if(type == 'legalrequests-report'){
          report_legalrequests.removeClass('hide');
      }else if(type == 'matter-litigation-update-report'){
          report_matter_litigation_update.removeClass('hide');
		  report_collective_filter.removeClass('hide');
      }else if(type == 'receivable-agreements-report'){
          report_agreements_receivable.removeClass('hide');
      }else if(type == 'payable-agreements-report'){
         report_agreements_payable.removeClass('hide');
      }else if(type == 'signed-agreements-report'){
         report_agreements_signed.removeClass('hide');
      }
  ...
  function matter_litigation_report() {
	...
	function matter_litigation_update_report() {
     if ($.fn.DataTable.isDataTable('.table-matter-litigation-update-report')) {
       $('.table-matter-litigation-update-report').DataTable().destroy();
     }
     _table_api = initDataTable('.table-matter-litigation-update-report', admin_url + 'reports/matter_litigation_update_report', false, false, fnServerParams, [
       [10, 'DESC'],
       [4, 'DESC'],
	...
	function matter_labourcase_report() {
     ...
     _table_api = initDataTable('.table-matter-labourcase-report', admin_url + 'reports/matter_labourcase_report', false, false, fnServerParams, [
       ...
       ],20);//.column(3).visible(false, false).columns.adjust();
   }
   ...
   function agreements_report() {
    ...
    function signed_agreements_report() {
    ...
    function receivable_agreements_report() {
    ...
    function payable_agreements_report() {
   ...
   function matter_hearing_report() {
	...
	function matter_legalaction_report() {
     ...
     _table_api = initDataTable('.table-matter-legalaction-report', admin_url + 'reports/matter_legalaction_report', false, false, fnServerParams, [
       [2, 'DESC'],
       [0, 'DESC']
       ],14);//.column(3).visible(false, false).columns.adjust();
   }
	...
	function matter_totalreceived_report() {
     ...
     _table_api = initDataTable('.table-matter-totalreceived-report', admin_url + 'reports/matter_totalreceived_report', false, false, fnServerParams, [
       [2, 'DESC'],
       [0, 'DESC']
       ],10);//.column(3).visible(false, false).columns.adjust();
   }
	...
	function matter_companycase_report() {
     if ($.fn.DataTable.isDataTable('.table-matter-companycase-report')) {
       $('.table-matter-companycase-report').DataTable().destroy();
     }
     _table_api = initDataTable('.table-matter-companycase-report', admin_url + 'reports/matter_companycase_report', false, false, fnServerParams, [
       [2, 'DESC'],
       [0, 'DESC']
       ],17);//.column(3).visible(false, false).columns.adjust();
   }
	...
	function matter_handover_report() {
     if ($.fn.DataTable.isDataTable('.table-matter-handover-report')) {
       $('.table-matter-handover-report').DataTable().destroy();
     }
     _table_api = initDataTable('.table-matter-handover-report', admin_url + 'reports/matter_handover_report', false, false, fnServerParams, [
       [2, 'DESC'],
       [0, 'DESC']
...
function legalrequests_report() {
   ...
   function gen_reports() {
     ...
     }else if (!report_matter_litigation_update.hasClass('hide')) { 
       matter_litigation_update_report();
     ...
     }else if (!report_matter_companycase.hasClass('hide')) { 
       matter_companycase_report();
     }else if (!report_matter_handover.hasClass('hide')) { 
       matter_handover_report();
     }else if (!report_legalrequests.hasClass('hide')) { 
       legalrequests_report();
     }else if (!report_agreements_receivable.hasClass('hide')) { 
       receivable_agreements_report();
     }else if (!report_agreements_payable.hasClass('hide')) { 
       payable_agreements_report();
     }else if (!report_agreements_signed.hasClass('hide')) { 
       signed_agreements_report();
     }
