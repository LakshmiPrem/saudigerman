...
<div class="modal fade email-template" data-editor-id=".<?php echo 'tinymce-'.$Notice->id; ?>" id="Notice_send_to_client_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            $selected = array();
                            $contacts = $this->clients_model->get_contacts($Notice->client,array('active'=>1,'Notice_emails'=>1));
                            ...
                            echo render_select('sent_to[]',$contacts,array('id','email','firstname,lastname'),'Notice_send_to',$selected,array('multiple'=>true),array(),'','',false);
