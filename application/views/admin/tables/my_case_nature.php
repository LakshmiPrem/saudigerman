...
foreach ($rResult as $aRow) {
    $row = array();
        ...
        $row[] = '<a href="#" onclick="edit_case_nature(this,'.$aRow['id'].'); return false;" data-name="'.$aRow['name'].'">' . $aRow['name'] . '</a> '. '<span class="badge pull-right">'.total_rows('tblcase_details',array('instance_casenature'=>$aRow['id'])).'</span>';;
