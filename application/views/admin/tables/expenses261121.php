...
foreach ($rResult as $aRow) {
    ...
    $appro_statuses = $this->ci->tickets_model->get_ticket_status();

    $row[] = render_select('approve_status',$appro_statuses,array('ticketstatusid','name'),'',$aRow['approve_status'],array('onchange' =>"change_expense_approval_status(this,'".$aRow['id']."')"),array(),'no-mbot','',false);//ticket_status_translate($aRow['approve_status']);
