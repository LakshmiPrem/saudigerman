...
foreach ($rResult as $aRow) {
    $row = array();
 $row[] = '<a href="#" onclick="edit_hallnumber(this,'.$aRow['id'].'); return false;" data-name="'.$aRow['name'].'">' . $aRow['name'] . '</a> '. '<span class="badge pull-right">'.total_rows('tblhearings',array('hall_number'=>$aRow['id'])).'</span>';
    ...
    $row[] = $toggleActive;
    $options = icon_btn('#', 'pencil-square-o','btn-default',array('onclick'=>'edit_hallnumber(this,'.$aRow['id'].'); return false;','data-name'=>$aRow['name']));
