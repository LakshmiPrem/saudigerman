...
if($this->ci->input->post('taskrelated_to')){
    if($this->ci->input->post('taskrelated_to')=='general')
         array_push($where,'AND tbltasks.rel_type  IS NULL');
     else
         array_push($where,'AND tbltasks.rel_type = "'.$this->ci->input->post('taskrelated_to').'"');
}

if($this->ci->input->post('taskrel_id')){
    array_push($where,'AND tbltasks.rel_id = '.$this->ci->input->post('taskrel_id'));
}
