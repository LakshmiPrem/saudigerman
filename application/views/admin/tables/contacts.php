...
$result = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, [db_prefix() . 'contacts.id as id', 'userid', 'is_primary','is_manager','is_director','is_secretary']);
...
foreach ($rResult as $aRow) {
	...
	$row[] =($aRow['is_manager']==1)?'Yes':'No';
	$row[] =($aRow['is_director']==1)?'Yes':'No';
	$row[] =($aRow['is_secretary']==1)?'Yes':'No';
