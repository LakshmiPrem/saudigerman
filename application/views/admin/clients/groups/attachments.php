    ...
    <div class="attachments">
            ...
            <table class="table dt-table" data-order-col="2" data-order-type="desc">
                <thead>
                    <tr>
                        ...
                        <th width="20%"><?php echo _l('customer_attachments_file'); ?></th>
                      <!--  <th><?php echo _l('customer_attachments_show_in_customers_area'); ?></th>-->
						...
						<th><?php echo _l('update_latest'); ?></th>
                   ...
                   <?php foreach($attachments as $type => $attachment){
                        ...
                        <?php foreach($attachment as $_att){
                            ...
                            <tr id="tr_file_<?php echo $_att['id']; ?>">
                              <td>
                              <?php	$attr11=array('placeholder'=>'Display Name ','onblur'=>'update_displayname(this,'.$_att['id'].')');
                                          ?>
                                    <?php echo render_input('display_name','', $_att['subject'],'text',$attr11); ?>
                               ...
                               /* if($is_image){
                                ...
                                ?>
                                <a href="#" class="display-block mbot5">
                                    <?php if($is_image){ ?>
      ...
      <!--                   <td>
						...
						<?php if(get_option('enable_sharepoint')==1){?>
                         ...
                         <td> <a href="<?php echo $_att['external_sharepoint_link'] ?>"  target="_blank" class="btn btn-warning btn-sm maleft10" ><i class="fa fa-file-word-o"></i> <?php echo _l('view_edit') ?> </a></td>
						   <td>
                      <a href="#" class="btn btn-info btn-icon" onclick="update_sharepoint(<?=$_att['id']?>,<?=$_att['rel_id']?>,'customer'); return false;"><i class="fa fa-file-word-o"> <?php echo _l('load'); ?> </a></td>
					 <?php } ?>
                        <td>
