         ...
         <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab')){echo ' active';}; ?>" id="contact_info">
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <?php $yes_no_arr = [['id'=>'main','name'=>'Main'],['id'=>'branch','name'=>'Branch']]  ?>
                  <?php  $selected = ( isset($client) ? $client->company_type : 'main'); ?>
                  <?php echo render_select('company_type',$yes_no_arr,array('id','name'),'company_type',$selected);?>

                  <div class="main_div hide">
                     <?php  $selected = ( isset($client) ? $client->parent_company : ''); ?>
                     <?php echo render_select('parent_company',$parent_company,array('userid','company'),'parent_company',$selected);?>
                 </div>
                  ...
                  <div id="company_exists_info" class="hide"></div>
                     <?php $value=( isset($client) ? $client->client_no : ''); ?>
                  <?php echo render_input('client_no', 'client_no',$value); ?>
               ...
               <div class="col-md-6">
                  <?php $selected = (isset($client) ? $client->client_type : 'Internal') ?>
                <?php $ind_company_types = get_lead_client_types(); ?> 
                <?php echo render_select('client_type',$ind_company_types,array('id','name'),'client_type',$selected) ?>
                  ...
                  <?php $countries= get_all_countries();
                     ...
                     ?>
                  <?php
                $selected = (isset($client) ? $client->refered_employee_id : '');
              //  echo render_select('refered_employee_id',$all_staff,array('staffid',array('firstname','lastname')),'refered_employee_id',$selected);
               ?>

               <?php
                $selected = (isset($client) ? $client->lawyer_assigned : '');
                echo render_select('lawyer_assigned',$all_staff,array('staffid',array('firstname','lastname')),'lawyer_assigned',$selected);
               ?>
               </div>
            </div>
         </div>
