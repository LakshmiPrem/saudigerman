...
<a onclick="new_quick_contract(<?=$client->userid?>,'<?=$client->company?>');return false;" href="#" class="btn btn-info mbot25<?php if($client->active == 0){echo ' disabled';} ?>"><?php echo _l('new_contract'); ?></a>
