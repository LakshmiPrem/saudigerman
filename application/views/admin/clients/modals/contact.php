            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php $selected=( isset($contact) ? $contact->stakeholder_id : ''); ?>
                         <?php echo render_select_with_input_group('stakeholder_id',$stakeholders,array('id','shareholder_name'),'stakeholder_name',$selected,'<a href="#" data-toggle="modal" data-target="#customer_shareholder_modal"><i class="fa fa-plus"></i></a>');?> 
                    ...
                    <input type="checkbox" name="is_owner" id="contact_owner" <?php if((isset($contact) && $contact->is_owner == 1)){echo 'checked';}; ?> >
                    <label for="contact_owner">
                        <?php echo _l( 'contact_owner'); ?>
                    </label>
                </div>
                		<div class="checkbox checkbox-primary">
                    <input type="checkbox" name="is_manager" id="contact_manager" <?php if((isset($contact) && $contact->is_manager == 1)){echo 'checked';}; ?> >
                    <label for="contact_manager">
                        <?php echo _l( 'contact_manager'); ?>
                    </label>
                </div>
                <div class="checkbox checkbox-primary">
                    <input type="checkbox" name="is_secretary" id="contact_secretary" <?php if((isset($contact) && $contact->is_secretary == 1)){echo 'checked';}; ?> >
                    <label for="contact_secretary">
                        <?php echo _l( 'contact_secretary'); ?>
                    </label>
                </div>
						</div>
                    <div class="col-md-6 mtop10">
                    <div class="checkbox checkbox-primary">
                    <input type="checkbox" name="is_partner" id="contact_partner" <?php if((isset($contact) && $contact->is_partner == 1)){echo 'checked';}; ?> >
                    <label for="contact_partner">
                        <?php echo _l( 'contact_partner'); ?>
                    </label>
                </div>
                  <div class="checkbox checkbox-primary">
                    <input type="checkbox" name="is_director" id="contact_director" <?php if((isset($contact) && $contact->is_director == 1)){echo 'checked';}; ?> >
                    <label for="contact_director">
                        <?php echo _l( 'contact_director'); ?>
                    </label>
                </div>
						</div>
				</div>
             ...
             <p class="bold"><?php echo _l('email_notifications'); ?><?php if(is_sms_trigger_active()){echo '/SMS';} ?></p>
                ...
                <div class="col-md-6 row">
                    <div class="row">
                             <div class="col-md-6 mtop10 border-right">
                            <span><?php echo _l('als_casediary'); ?></span>
                        </div>
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
