            ...
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <div class="checkbox">
                   ...
                   <div class="col-md-3">
                          <?php $types = [['id'=>'main','name'=>'Main'],['id'=>'branch','name'=>'Branch']]  ?>
                     <?php echo render_select('company_type',$types,array( 'id','name'), '','',array('data-none-selected-text'=>_l('customers_comp_all')));?>
                     </div>
				   </div>
...
<script>
   $(function(){
       ...
       CustomersServerParams['company_type'] = '[name="company_type"]';
