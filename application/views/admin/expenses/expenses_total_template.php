...
<div class="col-md-5ths col-xs-12 total-column">
  <div class="panel_s no-mbot">
    <div class="panel-body">
      <h3 class="text-muted _total">
       <?php echo $totals['all']['ptotal']; ?>
     </h3>
     <span class="text-warning"><?php echo _l('total_paid'); ?></span>
   </div>
 </div>
</div>
<div class="col-md-5ths col-xs-12 total-column hide">
  <div class="panel_s no-mbot">
    <div class="panel-body">
      <h3 class="text-muted _total">
       <?php echo $totals['all']['ntotal']; ?>
     </h3>
     <span class="text-warning"><?php echo _l('last_amount'); ?></span>
   </div>
 </div>
</div>
<div class="col-md-5ths col-xs-12 total-column">
  <div class="panel_s no-mbot">
    <div class="panel-body">
      <h3 class="text-muted _total">
       <?php echo $totals['all']['btotal']; ?>
     </h3>
     <span class="text-warning"><?php echo _l('balance'); ?></span>
   </div>
 </div>
</div>
<div class="col-md-5ths col-xs-12 total-column">
  <div class="panel_s no-mbot">
    <div class="panel-body">
      <h3 class="text-muted _total">
       <?php echo $totals['refundable']['total']; ?>
     </h3>
     <span class="text-success"><?php echo _l('expenses_list_refundable'); ?></span>
   </div>
 </div>
</div>
<div class="col-md-5ths col-xs-12 total-column">
  <div class="panel_s no-mbot">
    <div class="panel-body">
      <h3 class="text-muted _total">
       <?php echo $totals['non_refundable']['total']; ?>
     </h3>
     <span class="text-warning"><?php echo _l('expenses_list_non_refundable'); ?></span>
   </div>
 </div>
</div>
	<!--<div class="col-md-5ths col-xs-12 total-column">
