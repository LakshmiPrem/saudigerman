   ...
   <div class="row">
      <div class="lead-view<?php if(!isset($lead)){echo ' hide';} ?>" id="leadViewWrapper">
         ...
         <div class="col-md-4 col-xs-12 lead-information-col">
            <div class="lead-info-heading">
               <h4 class="no-margin font-medium-xs bold">
                  <?php echo _l('other_info'); ?>
               </h4>
            </div>
            <p class="text-muted lead-field-heading"><?php echo _l('refered_employee_id'); ?></p>
            <p class="bold font-medium-xs"><?php echo (isset($lead) && $lead->referred_staff_id != '' ? get_staff_full_name($lead->referred_staff_id) : '-') ?></p>
            <p class="text-muted lead-field-heading no-mtop"><?php echo _l('matter_templates'); ?></p>
            <p class="bold font-medium-xs mbot15"><?php echo (isset($lead) && $lead->matter_template_id != '' ? get_matter_template_name_by_id($lead->matter_template_id) : '-') ?></p>
      ...
      <div class="lead-edit<?php if(isset($lead)){echo ' hide';} ?>">
         ...
         <div class="col-md-4 mtop15">
            <?php
               $selected = (isset($lead) ? $lead->referred_staff_id : '');
               echo render_select('referred_staff_id',$members,array('staffid',array('firstname','lastname')),'referred_staff',$selected);
            ?>
         </div>

         <div class="col-md-4 mtop15">
            <?php $selected = (isset($lead) ? $lead->matter_template_id : ''); ?>
            <?php echo render_select('matter_template_id',$matter_templates,array('id','name'),'matter_templates',$selected); ?>
         </div>

         <div class="col-md-4 mtop15">
            <?php $value = (isset($lead) ? $lead->enquiry_title : ''); ?>
            <?php echo render_input('enquiry_title','enquiry_title',$value); ?>
         </div>
         ...
         <div class="clearfix"></div>
            <hr class="mtop5 mbot10" />
             <div class="col-md-4">
                ...
                echo render_select('client_id',$clients_,array('userid','company'),'client',$selected);?>
             </div>
             <div class="col-md-8">
         ...
         <div class="col-md-6">
            ...
            <?php 
               $emirates_arr = get_emirates();
               $selected = (isset($lead) ? $lead->state :'');
               echo render_select('state',$emirates_arr,array('id',array( 'name')),'lead_state',$selected); ?>
            <?php
            ...
            <?php } ?>
             <?php $value = (isset($lead) ? $lead->price_quoted : ''); ?>
            <?php echo render_input('price_quoted','price_quoted',$value); ?>
         </div>
         <div class="col-md-12">
