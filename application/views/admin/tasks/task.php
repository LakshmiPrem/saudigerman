         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        <label for="priority" class="control-label"><?php echo _l('task_add_edit_priority_sla'); ?></label>
                  ...
                  <?php ##################### ?>
                  <div class="col-md-6">
                    <?php $value = (isset($task) ? _d($task->sla_deadline_date) : _d(date('Y-m-d'))); ?>
                    <?php echo render_date_input('sla_deadline_date','sla_deadline_date',$value); ?>
                    <!-- <input type="hidden" id="hid_sla_date" name="hid_sla_deadline_date" value="<?=$value?>"  > -->
                  </div>
                  <?php ##################### ?>
                  <div class="col-md-6">
                     <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <select name="rel_type" class="selectpicker" id="rel_type" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                           ...
                           <option value="ticket" <?php if(isset($task) || $this->input->get('rel_type')){if($rel_type == 'ticket'){echo 'selected';}} ?>>
                            ...
                            <option value="legalrisk" <?php if(isset($task) || $this->input->get('rel_type')){if($rel_type == 'legalrisk'){echo 'selected';}} ?>>
                              <?php echo _l('legalrisk'); ?>
                           </option>
                           <option value="document" <?php if(isset($task) || $this->input->get('rel_type')){if($rel_type == 'document'){echo 'selected';}} ?>>
    						         <?php echo _l('safe_register'); ?>
 							      </option>
...
<!-- <script type="text/javascript">
   <?php $s =  get_tasks_priorities(); ?>;
  var sla_p =  <?php echo json_encode($s); ?>;
  ...
  function sla(priority){
    for(var t=0;t<sla_p.length;t++){
        if(sla_p[t]['id'] == priority){
          var days = sla_p[t]['days'];
          var startdate = $('#startdate').val();
          var Url = '<?php echo admin_url('tasks/get_sla_dead_line_date/') ?>'+days+'/'+startdate;  
          $.ajax({url: Url, success: function(result){
            $('#sla_deadline_date').val(result);
            $('#hid_sla_date').val(result);
