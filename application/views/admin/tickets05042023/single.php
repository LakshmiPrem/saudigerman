...
<div id="wrapper">
   <div class="content">
                  ...
                  <div class="horizontal-scrollable-tabs">
                     ...
                     <div class="horizontal-tabs">
                        <ul class="nav nav-tabs no-margin nav-tabs-horizontal" role="tablist">
                           <li role="presentation" class="<?php if($this->session->flashdata('active_tab_settings')|| ($confirmapproval=='request')){echo 'active';} ?>">
                           <a href="#settings" aria-controls="settings" role="tab" data-toggle="tab">
                              <?php echo _l('ticket_single_settings'); ?>
                           </a>
                        </li>
                           <li role="presentation" class="<?php if(!$this->session->flashdata('active_tab') && ($confirmapproval=='reply')){echo 'active';} ?>">
                        ...
                        <li role="presentation" class="<?php if(($confirmapproval=='approval')||$this->session->flashdata('active_tab_approvals')){echo 'active';} ?>">
         ...
         <div class="panel_s">
            <div class="panel-body">
               <div class="row">
                  ...
                  <div class="col-md-4 text-right">
                     ...
                     <div class="row">
                      ...
                      <a target="_blank" href="<?php echo admin_url('tickets/legal_approval/'.$ticket->ticketid); ?>" class="btn btn-default btn-with-tooltip" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Download Legal Request"> <i class="fa fa-file-pdf-o"></i>Legal Request  </a></div>
               ...
               <div class="tab-content">
                       <div role="tabpanel" class="tab-pane <?php if($this->session->flashdata('active_tab_settings') || ($confirmapproval=='request')){echo 'active';} ?>" id="settings">
                  <hr class="no-mtop" />
                  <div class="row">
                        ...
                        <div class="form-group select-placeholder">
                           <label for="contactid" class="control-label"><?php echo _l('related_branch'); ?></label>
                        ...
                        <?php 
							echo render_select('opposteparty',$oppositeparty_names,array('id','name'),'opposite_party',$ticket->opposteparty,array('required'=>'true'));
							//echo render_input('opposteparty','opposite_party',$ticket->opposteparty,'text',array('required'=>'true')); ?>
                     
                     </div>
                      <div class="col-md-6" <?php if(isset($ticket)){?> style="pointer-events: none;"<?php }?>>
               <?php $value = (isset($ticket) ? _d($ticket->estimated_date) : _d(date('Y-m-d'))); ?>
               <?php echo render_date_input('estimated_date','estimated_date',$value,array('readonly'=>'true')); ?>
            </div>
                     </div>
                    </div>
                    <div class="col-md-6">
                     ...
                     <div class="form-group select-placeholder">
                        ...
                        <select name="assigned" data-live-search="true" id="assigned" class="form-control selectpicker" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" required>
                    ...
                    <div class="col-md-6">
								<?php echo render_input('stamp_type','type_stamp',$ticket->stamp_type,'text'); ?>
							</div>
                     </div>
                     <div class="form-group select-placeholder projects-wrapper hide <?php if($ticket->userid == 0){echo ' hide';} ?>">
               ...
               <div class="row">
                  ...
                  <div role="tabpanel" class="tab-pane <?php if(!$this->session->flashdata('active_tab')&& ($confirmapproval=='reply')){echo 'active';} ?>" id="addreply">
                     <hr class="no-mtop" />
               ...
               <?php  if (count($staff_deparments_ids) != 0  || is_admin()) {
					$value = _d(date('Y-m-d')); ?>
               <?php echo render_date_input('estimated_date','estimated_date',$value); ?>
               <?php }?>
      ...
      <?php ###################### Approval ################################### ?>      
            <div role="tabpanel" class="tab-pane <?php if(($confirmapproval=='approval')|| $this->session->flashdata('active_tab_approvals')){echo 'active';} ?>" id="approval">
               <hr class="no-mtop" />
 <hr class="no-mtop" />
               <div class="row">
                  <div class="col-md-12">
                 ...
                 //    $approvalid= get_firstapproval_name($service,$ticket->service);
                     ...
                     <a class="btn btn-info" href="#" onclick="load_approval_modal('<?php echo admin_url('approval/approvals?rel_name='.$service.'&rel_id='.$ticket->ticketid); ?>');return false;"><?=_l('new_approval')?></a>
                      <?php } ?>
                  </div>
