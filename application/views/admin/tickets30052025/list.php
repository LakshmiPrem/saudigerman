...
<div id="wrapper">
           ...
           <?php if (has_permission('tickets','','create')){?>
            ...
            <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
              ...
              <?php } ?>
                   ...
                   <?php if(count($ticket_branches) > 0 && has_permission('tickets','','view')){ ?>
                <div class="clearfix"></div>
                <li class="divider"></li>
                <li class="dropdown-submenu pull-left">
                 <a href="#" tabindex="-1"><?php echo _l('filter_by_branches'); ?></a>
                 <ul class="dropdown-menu dropdown-menu-left">
                  <?php foreach($ticket_branches as $as){ ?>
                  <li>
                    <a href="#" data-cview="ticket_branch_<?php echo $as['userid']; ?>" onclick="dt_custom_view(<?php echo $as['userid']; ?>,'.tickets-table','ticket_branch_<?php echo $as['userid']; ?>'); return false;"><?php echo get_company_name($as['userid']); ?></a>
                  </li>
                  <?php } ?>
                </ul>
              </li>
              <?php } ?>
               ...
               <?php if(count($ticket_services) > 0 && has_permission('tickets','','view')){ ?>
                <div class="clearfix"></div>
                <li class="divider"></li>
                <li class="dropdown-submenu pull-left">
            ...
            <?php foreach($years as $year){ ?>
                <li class="active">
                    <a href="#" data-cview="year_<?php echo $year['year']; ?>" onclick="dt_custom_view(<?php echo $year['year']; ?>,'.tickets-table','year_<?php echo $year['year']; ?>'); return false;"><?php echo $year['year']; ?>
                </a>
            </li>
        <?php } ?>
    <?php } ?>
    ...
    <li class="dropdown-submenu pull-left">
        ...
        <ul class="dropdown-menu dropdown-menu-left">
            <?php for ($m = 1; $m <= 12; $m++) { ?>
                <li><a href="#" data-cview="tickets_by_month_<?php echo $m; ?>" onclick="dt_custom_view(<?php echo $m; ?>,'.tickets-table','tickets_by_month_<?php echo $m; ?>'); return false;"><?php echo _l(date('F', mktime(0, 0, 0, $m, 1))); ?></a></li>
            <?php } ?>
        </ul>
    </li>
    <div class="clearfix"></div>
