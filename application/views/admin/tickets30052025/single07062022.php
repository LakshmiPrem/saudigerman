   ...
   <div class="content">
                  ...
                  <div class="horizontal-scrollable-tabs">
                     ...
                     <div class="horizontal-tabs">
                        <ul class="nav nav-tabs no-margin nav-tabs-horizontal" role="tablist">
                            <li role="presentation" class="<?php if($ticket->service ==1 || $ticket->service ==10){ if(!$this->session->flashdata('active_tab')){echo ' active';}} ?>">
                              <a href="#civilrequest" aria-controls="addcivil" role="tab" data-toggle="tab" class="<?php if($ticket->service !=1 && $ticket->service !=10)echo 'hide'?>">
                                 <?php echo _l('ticket_single_add_civil'); ?>
                              </a>
                           </li>
                              <li role="presentation" class="<?php if($ticket->service ==2 || $ticket->service ==11){ if(!$this->session->flashdata('active_tab')){echo ' active';}} ?>">
                              <a href="#policerequest" aria-controls="addpolice" role="tab" data-toggle="tab" class="<?php if($ticket->service !=2 && $ticket->service !=11)echo 'hide'?>">
                        ...
                        <li role="presentation" class="<?php if(isset($confirmapproval)||$this->session->flashdata('active_tab_approvals')){echo 'active';} ?>" >
         ...
         <div class="panel_s">
            <div class="panel-body">
               <div class="row">
                  ...
                  <div class="col-md-6 text-right">
                     ...
                     <div class="row">
                      ...
                      <?php }
								  else if(($ticket->service=='5')|| ($ticket->service=='3')){ ?>
                      ...
                      <?php
								  ...
								  else if(($ticket->service=='6')|| ($ticket->service=='9')){ ?>
                      ...
                      <?php
                        ...
                        <div class="col-md-4 col-md-offset-4">
                           <?php echo render_select('status_top',$statuses,array('ticketstatusid','name'),'',$ticket->status,array('disabled'=>true),array(),'no-mbot','',false); ?>
                        </div>
                     </div>
                  </div>
                  <div class="clearfix"></div>
               ...
               <div class="tab-content">
                                         <div role="tabpanel" class="tab-pane <?php if($ticket->service ==1 || $ticket->service ==10){ if(!$this->session->flashdata('active_tab')){echo 'active';}} ?>" id="civilrequest">
                  <hr class="no-mtop" />
                  <div class="row">
	...
	if(isset($civil)&& ($civil->owner_detail!='')){
      ...
      <div class="clearfix"></div><br>
            ...
            <!-- ###Police Request -->
             <div role="tabpanel" class="tab-pane <?php if($ticket->service ==2 || $ticket->service ==11){ if(!$this->session->flashdata('active_tab')){echo 'active';}} ?>" id="policerequest">
                  <hr class="no-mtop" />
	...
	if(isset($police)&& ($police->owner_detail!='')){
      ...
      <div class="clearfix"></div><br>
             ...
             <?php echo form_close(); ?>
                  ...
                  <div role="tabpanel" class="tab-pane <?php if($ticket->service !=1 && $ticket->service !=2  && $ticket->service ==10 && $ticket->service ==11){ if(!$this->session->flashdata('active_tab')){echo 'active';}} ?>" id="addreply">
                     <hr class="no-mtop" />
	    ...
	    echo render_select('service',$services,array('serviceid','name'),'ticket_settings_service',$ticket->service,array('disabled'=>true));
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="form-group select-placeholder projects-wrapper<?php if($ticket->userid == 0){echo ' hide';} ?>">
						...
						<?php if(($ticket->service=='6')|| ($ticket->service=='9')){?>
	...
	?>
              ...
              <?php } ?>
              		<!--  Additional data for Credit Application ------>
              		 	<?php if(($ticket->service=='5')|| ($ticket->service=='3')){?>
                     ...
                     <td><?=get_document_type_name($row['document_type'])?></td>
                      <td><?=$row['document_number']; ?></td>
                       <td><?=$row['document_name']; ?></td>
                        ...
                        <?php if (has_permission('tickets','','edit')){?>  <td><a class="btn btn-info mbot25" href="#" onclick="showAjaxModal('<?php echo admin_url();?>tickets/editcredit/<?php echo $row['id']?>');">	<i class="fa fa-pencil"></i></a></td><?php } ?>
      ...
      <?php ###################### Approval ################################### ?>      
            <div role="tabpanel" class="tab-pane <?php if(isset($confirmapproval)||$this->session->flashdata('active_tab_approvals')){echo 'active';} ?>" id="approval">
               <hr class="no-mtop" />
               <div class="row">
                  <div class="col-md-12">
                           ...
                           <tr>
                              <th>
                                 ...
                                 <div class="col-md-3 mtop20">
                                    <?php  if($approval['staffid'] != get_staff_user_id() || $approval['approval_status']!=2){ 
                                 ...
                                 <?php if(($ticket->service==5)|| ($ticket->service==6)|| ($ticket->service==3)|| ($ticket->service==9)){?>
                                  <div class="col-md-3">
								  </div>
...
<!--  Additional data for Credit Application Approval------>
	    ...
	    echo render_select('cheque_type',$credit_cheque,array('id','name'),'ticket_creditcheque',$value,array());
                  ...
                  <?php } ?>
                        <?php if(($ticket->service=='6')||($ticket->service=='3') || ($ticket->service=='5') || ($ticket->service=='9')){?>
<!--  Additional data for Credit Application Approval------>
			...
			<div class="col-md-12 text-center">
                  ...
                  <?php } ?>
					...
					$service='general';
						if($ticket->service==1)
							$service='civil';
						elseif($ticket->service==2)
							$service='police';
						elseif($ticket->service==10)
							$service='civil1';
						elseif($ticket->service==11)
							$service='police1';
						elseif($ticket->service==6)
							$service='credit';
						elseif($ticket->service==5)
							$service='credit1';
						elseif($ticket->service==7)
							$service='closure';
						elseif($ticket->service==9)
							$service='credito';
						elseif($ticket->service==3)
							$service='credit1o';
						 else
							 $service='general';
                     $approval_types = get_approval_types($service); 
	
                     $approvalid= get_firstapproval_name($service);?>
                     <tr>
                           ...
                           <div class="form-group select-placeholder">
                              <select name="approval_assigned[]" data-live-search="true" id="approval_assigned" class="form-control selectpicker" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                 ...
                                 <?php foreach($staff as $member){
                                    ...
                                    ?>
                                    <option value="<?php echo $member['staffid']; ?>" <?php if(get_staff_user_id() == $member['staffid'] && $approval_type['id']==$approvalid){echo 'selected';} ?>>
                                       <?php echo $member['firstname'] . ' ' . $member['lastname'] ; ?>
                                    </option>
                                 <?php } ?>
                              </select>
