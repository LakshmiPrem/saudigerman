					...
					<div class="col-md-6">
						...
						<div class="row">
							...
							<?php $yes_no_arr = [['id'=>'no','name'=>'No'],['id'=>'yes','name'=>'Yes']]  ?>
								  <?php echo render_select('amount_related',$yes_no_arr,array('id','name'),'amount_relatednot','');?>
						</div>
							<div class="col-md-6">
						...
						<?php 
							echo render_select('opposteparty',$oppositeparty_names,array('id','name'),'opposite_party','',array('required'=>'true'));
							//echo render_input('opposteparty','opposite_party','','text',array('required'=>'true')); ?>
