				...
				<div class="panel_s">
					...
					<div class="panel-footer attachments_area">
						<div class="row attachments">
							<div class="attachment">
								...
								<div class="col-md-4 col-md-offset-2 mbot15"  id="doctype">
								      <div class="form-group">
                  ...
                  <select class="form-control" name="document_type[]">
                     ...
                     <?php } ?>
									...
									<div class="col-md-3 mbot15 hide"  id="docnumber">
									<label for="cars"><?php echo _l('document_number'); ?></label>
									<input type="text" name="document_number[]" placeholder="Enter Document Number" class="form-control" value=""  />
								
						</div>
									<div class="col-md-3 mbot15 hide"  id="docname">
									<label for="cars"><?php echo _l('document_name'); ?></label>
									<input type="text" name="document_name[]" placeholder="Enter Document Name" class="form-control" value=""  />
								
						</div>
									<div class="col-md-3 mbot15 hide"  id="docnation">
                   <div class="form-group">
                     <label class=""><?php echo _l('nationality'); ?></label>
                  <select class="form-control" name="nationality[]">
                     <option></option>
                     <?php foreach($nationality as $nat_type){ ?>
                        <option value="<?=$nat_type['id']?>" ><?=$nat_type['nation']?></option>
                     <?php } ?>
                  </select>
									</div>
                  ...
                  <div class="col-md-3 mbot15 hide"  id="docexpiry">
                  <label for="cars"><?php echo _l('expiry_date'); ?></label>
									<input type="date" name="expiry_date[]" placeholder="Enter Expiry Date" class="form-control" value=""  />
                
                  </div>
                  <div class="col-md-5 mbot15 hide" id="docremark">
                    <label for="cars"><?php echo _l('remarks'); ?></label>
...
<script>
	$(function(){
		...
		//$('#document_type').prop('required',true);
			...
			{
				 $('#docremark').removeClass('hide');
				$('#docname').removeClass('hide');
				$('#docnumber').removeClass('hide');
				$('#docexpiry').removeClass('hide');
				$('#docnation').removeClass('hide');
				$('#doctype').removeClass('col-md-4 col-md-offset-2');
					$('#doctype').addClass('col-md-3');
				$('input[name="customer_code"]').prop('required',true);
				$('.attachments input[name*="attachments"]').prop('required',true);
				 $('select[name*="document_type"]').prop('required',true);
			}
