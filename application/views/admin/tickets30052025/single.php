		...
		<div class="row " id="creditapproval">
          ...
          <?php } else{  ?>
				...
				//  $approval_types = get_approval_types('ticket',$ticket->service); 
                     ...
                     <a class="btn btn-info" href="#" onclick="load_ticketapproval_modal('<?php echo admin_url('tickets/update_single_ticket_approvals?rel_name='.$service_ticket.'&rel_id='.$ticket->ticketid); ?>');return false;">New Approval</a>
                      <?php // } ?>
                      </div>
				</div>
