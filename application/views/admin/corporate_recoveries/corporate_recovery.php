      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <div class="alert alert-warning">
               ...
               <br />
               <a href="<?php echo admin_url('corporate_recoveries/mark_as_active/'.$client->userid); ?>"><?php echo _l('mark_as_active'); ?></a>
            </div>
            <?php } ?>
           
            <?php if(isset($client) && (!has_permission('corporate_recovery','','view') && is_customer_admin($client->userid))){?>
            ...
            <div class="panel_s">
               <div class="panel-body customer-profile-tabs">
                  <h4 class="customer-heading-profile bold">
                       <?php if(has_permission('corporate_recovery','','delete') || is_admin()){ ?>
                  <div class="btn-group pull-left mright10">
                     ...
                     <ul class="dropdown-menu dropdown-menu-left">
                        ...
                        <li>
                           <a href="<?php echo admin_url('corporate_recoveries/delete/'.$client->userid); ?>" class="text-danger delete-text _delete"><i class="fa fa-remove"></i> <?php echo _l('delete'); ?>
                           </a>
                        </li>
                        <?php } ?>
                     </ul>
                  ...
                  <?php } ?>
                  #<?php echo $client->file_no . ' ' . $title; ?></h4>
                  <?php $this->load->view('admin/corporate_recoveries/tabs'); ?>
               ...
               <div class="panel-body">
                  ...
                  <div>
                     <div class="tab-content">
                        <?php $this->load->view('admin/corporate_recoveries/groups/'.$group); ?>
                     </div>
                  </div>
               </div>
            </div>
...
<script>
   $(function(){
      init_rel_tasks_table(<?php echo $client->userid; ?>,'recovery');
   });
</script>
<?php } ?>
...
<?php } ?>
<?php $this->load->view('admin/corporate_recoveries/corporate_js'); ?>
</body>
</html>
