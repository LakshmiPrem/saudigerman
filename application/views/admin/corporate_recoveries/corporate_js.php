...
/**********************************************************************************************/
   ...
   initDataTable('.table-credit-notes', admin_url+'credit_notes/table/'+customer_id, ['undefined'], ['undefined'], undefined, [0, 'DESC']);
    ...
    initDataTable('.table-reminders', admin_url + 'misc/get_reminders/' + customer_id + '/' + 'corporate', [4], [4], undefined, [1, 'ASC']);
    ...
    initDataTable('.table-projects-single-client', admin_url + 'projects/table/' + client_id, [notSortableProjects], [notSortableProjects], 'undefined', <?php echo hooks()->apply_filters('projects_table_default_order',json_encode(array(5,'ASC'))); ?>);
