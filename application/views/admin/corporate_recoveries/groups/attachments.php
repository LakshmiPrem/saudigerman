...
<hr />
<?php if(isset($client)){ ?>
<?php echo form_open_multipart(admin_url('corporate_recoveries/upload_attachment/'.$client->userid),array('class'=>'dropzone','id'=>'client-attachments-upload')); ?>
            ...
            <tbody>
                <?php foreach($attachments as $type => $attachment){
                    ...
                    if($type == 'invoice'){
                        ...
                        $url = site_url() .'download/file/corporate/';
                        $download_indicator = 'rel_id';
                    }
                    ...
                    <td>
                        ...
                        <a href="<?php echo admin_url('corporate_recoveries/delete_attachment/'.$_att['rel_id'].'/'.$_att['id']); ?>"  class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
                        <?php } ?>
                    </td>
                    <?php } ?>
                </tr>
