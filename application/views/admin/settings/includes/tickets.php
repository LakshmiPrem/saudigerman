...
<div class="tab-content mtop30">
  <div role="tabpanel" class="tab-pane active" id="set_tickets_general">
    ...
    <?php render_yes_no_option('enable_single_assignee','enable_single_assignee'); ?>
    <hr />

    <?php render_yes_no_option('enable_legal_request','enable_legal_request'); ?>
    <hr />
    <?php render_yes_no_option('enable_legal_request_approval','enable_legal_request_approval'); ?>
    <hr />

    <?php echo render_select('settings[legal_request_single_assignee_id]',$staffs,array('staffid',array('firstname','lastname')),'legal_request_single_assignee_id',get_option('legal_request_single_assignee_id'),array(),array(),'','',false); ?>

    <hr />
    <?php render_yes_no_option('contract_approval','contract_approval','',_l('sequential'),_l('parallel'),'sequential','parallel'); ?>
    <hr />
<?php $auto_assign_staffs = json_decode(get_option('auto_ticketmail_staffs'));?>
<?php echo render_select('settings[auto_ticketmail_staffs][]',$staffs,array('staffid',array('firstname','lastname')),'auto_ticketmail_staffs',$auto_assign_staffs,['multiple'=>true]); ?>
<hr />
<?php echo render_select('settings[ticket_default_service]',$services,array('serviceid','name'),'ticket_default_service',get_option('ticket_default_service')); ?>
<hr />
<?php echo render_select('settings[ticket_civilcase_service]',$services,array('serviceid','name'),'ticket_civilcase_service',get_option('ticket_civilcase_service')); ?>
<hr />
 <?php echo render_select('settings[ticket_policecase_service]',$services,array('serviceid','name'),'ticket_policecase_service',get_option('ticket_policecase_service')); ?>
<hr />
 <?php echo render_select('settings[ticket_legalclosure_service]',$services,array('serviceid','name'),'ticket_legalclosure_service',get_option('ticket_legalclosure_service')); ?>
<hr />
  <?php echo render_select('settings[ticket_creditapplication_service]',$services,array('serviceid','name'),'ticket_creditapplication_service',get_option('ticket_creditapplication_service')); ?>
<hr />  
<?php echo render_select('settings[ticket_creditrevision_service]',$services,array('serviceid','name'),'ticket_creditrevision_service',get_option('ticket_creditrevision_service')); ?>
<hr />  
    <?php
