...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation">
     ...
     <li role="presentation">
        <a href="#pdf_footer" aria-controls="invoice" role="tab" data-toggle="tab"><?php echo _l('pdf_footer_image'); ?></a>
    </li>
     <li role="presentation">
        <a href="#pdf_header" aria-controls="invoice" role="tab" data-toggle="tab"><?php echo _l('pdf_header_image'); ?></a>
    </li>
</ul>
...
<?php hooks()->do_action('after_pdf_document_formats'); ?>
 ...
 <div role="tabpanel" class="tab-pane" id="pdf_footer">
     <?php render_yes_no_option('show_pdf_footer_image_invoice','show_pdf_footer_image_invoice'); ?>
     <hr />
     <?php render_yes_no_option('show_pdf_footer_image_estimate','show_pdf_footer_image_estimate'); ?>
     <hr />
    
     <?php $footer_image = get_option('pdf_footer_image'); ?>
     <?php if($footer_image != ''){ ?>
     <div class="form-group">
        <div class="row">
            <div class="col-md-9">
                <img src="<?php echo base_url('uploads/company/'.$footer_image); ?>" class="img img-responsive">
            </div>
            <?php if(has_permission('settings','','delete')){ ?>
            <div class="col-md-3 text-right">
                <a href="<?php echo admin_url('settings/remove_footer_image'); ?>" class="_delete text-danger"><i class="fa fa-remove"></i></a>
            </div>
            <?php } ?>
        </div>
    </div>
    ...
    <?php } else { ?>
    <div class="form-group">
        <label for="pdf_footer_image" class="control-label"><?php echo _l('pdf_footer_image'); ?></label>
        <input type="file" name="pdf_footer_image" class="form-control">
    </div>
    <?php } ?>
</div>
 <div role="tabpanel" class="tab-pane" id="pdf_header">
    
    
     <?php $header_image = get_option('pdf_header_image'); ?>
     <?php if($header_image != ''){ ?>
     <div class="form-group">
        <div class="row">
            <div class="col-md-9">
                <img src="<?php echo base_url('uploads/company/'.$header_image); ?>" class="img img-responsive">
            </div>
            <?php if(has_permission('settings','','delete')){ ?>
            <div class="col-md-3 text-right">
                <a href="<?php echo admin_url('settings/remove_header_image'); ?>" class="_delete text-danger"><i class="fa fa-remove"></i></a>
            </div>
            <?php } ?>
        </div>
    </div>
    ...
    <?php } else { ?>
    <div class="form-group">
        <label for="pdf_header_image" class="control-label"><?php echo _l('pdf_header_image'); ?></label>
        <input type="file" name="pdf_header_image" class="form-control">
    </div>
    <?php } ?>
</div>
</div>
