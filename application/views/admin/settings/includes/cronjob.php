...
<div class="tab-content">
 ...
 <div role="tabpanel" class="tab-pane" id="contracts">
  ...
  <hr />
   ...
   <hr />
   <i class="fa fa-question-circle pull-left" data-toggle="tooltip" data-title="<?php echo _l('settings_approval_reminders_contracts_tooltip'); ?>"></i>
   <?php echo render_input('settings[approval_expiration_before]','send_approval_expiry_reminder_before',get_option('approval_expiration_before'),'number'); ?>
