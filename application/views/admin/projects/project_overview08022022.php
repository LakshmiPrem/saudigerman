...
<div class="row">
   <div class="col-md-12 project-overview-expenses-finance">
      <div class="col-md-4">
         ...
         <p class="bold font-medium"><?php echo app_format_money(sum_from_table(db_prefix().'case_details',array('where'=>array('project_id'=>$project->id),'field'=>'claiming_amount')), $currency); ?></p>
      </div>
      <div class="col-md-4">
      ...
      <div class="col-md-4">
         ...
         <p class="bold font-medium"><?php
			 $total=sum_from_table(db_prefix().'case_details',array('where'=>array('project_id'=>$project->id),'field'=>'claiming_amount'));
...
<div class="project-overview-timesheets-chart">
    <div class="row">
      <div class="col-md-12">
         <p class="text-uppercase bold text-dark font-medium">
            <a class="" data-toggle="collapse" href="#lcourtupdate" role="button" aria-expanded="false" aria-controls="collapseExample"><?php echo _l('project_court_attach_grant'); ?></a>
         </p>
  ...
  <tbody>
    <?php //if(isset($scope)){
      foreach ($court_order as $row_) { ?>
        ...
        <td><?=get_courtorder_type_name($row_['documentid']);?></td>
