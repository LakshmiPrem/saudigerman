...
<?php init_head(); ?>
<?php $work_type = (isset($work_type)) ? $work_type : ' ';?>
<div id="wrapper">
  <div class="content">
    <div class="row">
      <div class="col-md-12">
            <div class="panel_s">
              ...
              <div class="col-md-4">
                <?php $case_types = get_case_client_types($work_type);?>
                <?php echo render_select('case_type',$case_types,array('id','name'),'case_type');?>

              </div>

              <div class="col-md-2 hide">
                            <?php  $worktypes=get_court_types(); ?>
                            <div class="form-group select-placeholder">
                                <?php echo render_select('work_type',$worktypes,array('id','name'),'work_type',$work_type);?>
                            </div>
                        </div>
              ...
              <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
               ...
               <div class="row mbot15">
                <div class="col-md-12">
                  ...
                  if($work_type != '')   
                  $_where .= ' case_type IN (SELECT id FROM '.db_prefix().'project_types WHERE type ="'.$work_type.'")';
                  ?>
                </div>
...
$(function(){
     ...
     ProjectsServerParams['work_type'] = '[name="work_type"]';
