...
<script>
   ...
   $(function(){
    ...
    $('[data-group="project_case_details"]').text('<?=_l($project->case_type)?>');
...
//	alert(courtid);
   if(courtname == 'All' || courtname == 'all' ){
      $('#btn_add_hearing').text('<?php echo _l('add_new'); ?>');
	    hearingTable('all',<?php echo $project->id;?>);
   }else{
      $('#btn_add_hearing').text('<?php echo _l('add_new'); ?> '+courtname);
	   
	     hearingTable(courtid,<?php echo $project->id;?>);
   }
   //$('#hearing-form select[name="hearing_type"]').val(courtid); 
   var ctype = $('select[name="hearing_type"]');
	
    ctype.selectpicker('val',courtid);
...
<script type="text/javascript">
   ...
   function change_expense_approval_status(th,id) {
    ...
    $('#project-expense-form input[name="amount"] ,input[name="paid_amount"] ,input[name="balance_amount"]').blur(function(){
         var total_amount = $('#project-expense-form input[name="amount"]').val();
         var paid_amount = $('#project-expense-form input[name="paid_amount"]').val();
         var balance = $('#project-expense-form input[name="balance_amount"]').val();
         var balance = total_amount - paid_amount;
         $('#project-expense-form input[name="balance_amount"]').val(balance);
...
$('select[name="h_client_position"]').change(function(){
