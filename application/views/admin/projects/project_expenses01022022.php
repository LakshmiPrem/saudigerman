                              ...
                              <th>
                                 <div class="col-md-4">
                                    ...
                                    <div class="col-md-4 mtop20">
                                      <?php  if(($approval['staffid'] != get_staff_user_id())|| ($approval['approval_status']==3)){ 
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <div class="row">
               <div class="col-md-6"><?php echo render_input('paid_amount','last_amount','','number'); ?></div>
               <div class="col-md-6"><?php echo render_input('vat_amount','vat','','number'); ?> </div>
				<div class="col-md-12"><?php echo render_input('balance_amount','balance','','number'); ?> </div>
            </div>
            ...
            <div class="col-md-4">
            <div class="checkbox checkbox-primary">
               <input type="checkbox" id="refundable" name="refundable" <?php if(isset($expense)){if($expense->refundable == 1){echo 'checked';}}; ?>>
