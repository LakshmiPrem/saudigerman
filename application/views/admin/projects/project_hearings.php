...
<a href="#" id="btn_add_hearing" class="btn btn-info mbot25" onclick="init_hearing(); return false;"><?php echo _l('add_new').' '._l('hearing'); ?> </a>
...
<ul class="nav nav-tabs hearing" role="tablist" id="myTab">
 ...
 <?php foreach ($hearing_types as  $court) {  ?>
      ...
      <li role="presentation" <?php if($hearing_type_tab == $court['id']) {  ?> class="active" <?php } ?> id="<?=$court['id']?>">
...
<div class="tab-content">
 ...
 <div role="tabpanel" class="tab-pane  active" id="tab_content-all">
      ...
      <table class="table dt-table scroll-responsive  table-all-hearings " data-order-col="1" data-order-type="asc">
        ...
        <thead>
          ...
          <tr> 
            ...
            <th><?php echo _l('mention_hearing'); ?></th>
  ...
  <?php } ?>
    ...
    <tr> 
      ...
      <th class="not_visible"><?php echo _l('hearing_type'); ?></th> 
