<?php ############### New Approval Start ##################### ?>
  <?php $record_sts = get_approval_record_status($project->id);
   ...
   <?php } 
      ...
      <a href="#" data-container="body" data-toggle="popover" data-placement="top" data-content="Please approve all the expenses & Reload the page."  class="btn btn-info mbot25"> <?php echo _l('add_new').' '._l('approval'); ?></a>
   <?php } ?>
