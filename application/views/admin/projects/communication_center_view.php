              ...
              <thead>
                ...
                <tr>
                  ...
                  <?php  foreach ($data->attachments as $value) { 
                    $path = PROJECT_ATTACHMENTS_FOLDER .$data->case_id.'/'.$value['file_name'];
                    ?>
                      <li class="list-item">
                        <?php
                        
                         ?>
                        <a href="<?php echo site_url('uploads/projects/'.$data->case_id.'/'.$value['file_name']); ?>" target="_blank" ><?=$value['file_name']?></a></li>
                  <?php } ?>
                </ol></th>
                </tr>
              </thead>
