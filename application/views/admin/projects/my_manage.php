      ...
      <div class="col-md-12">
            ...
            <div class="panel_s">
              ...
              <?php if(has_permission('projects','','create')){ ?>
                ...
                <a href="<?php echo admin_url('projects/project?case_type='.$case_type); ?>" class="btn btn-info pull-left display-block mright5">
              ...
              <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
               ...
               <div class="row mbot15">
                ...
                <div class="col-md-12">
                  ...
                  <h4 class="no-margin"><?php echo _l($case_type).' '._l('summary'); ?></h4>

                  <?php

                   $_where = 'case_type="'.$case_type.'"';
                ...
                <div class="_filters _hidden_inputs">
                  ...
                  echo form_hidden('case_type',$case_type);
...
$(function(){
     ...
     initDataTable('.table-projects', admin_url+'projects/table', undefined, undefined, ProjectsServerParams, <?php echo hooks()->apply_filters('projects_table_default_order', json_encode(array(0,'desc'))); ?>);
