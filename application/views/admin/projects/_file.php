         ...
         <div class="modal-body">
            ...
            <div class="row">
               ...
               <div class="col-md-6 border-right project_file_area">
                  ...
                  <?php echo render_input('_file_subject', 'project_discussion_subject', $file->subject, 'text', ['onblur' => 'update_file_data(' . $file->id . ')']); ?>
                  ...
                  <div class="col-md-6">
                     ...
                     <?php echo render_input('_issue_date','issue_date',$value,'date',array('onblur'=>'update_file_data('.$file->id.')')); ?> 
                  ...
                  <?php $value = (isset($file->expiry_date) ? $file->expiry_date : _d(date('Y-m-d'))); ?>
                   ...
                   <div class="col-md-6">
                     ...
                     <?php echo render_input('_expiry_date','expiry_date',$value,'date',array('onblur'=>'update_file_data('.$file->id.')')); ?> 
                  ...
                  <select class="form-control" id="_document_type" name="_document_type" onchange="update_file_data(<?=$file->id?>)">
                  ...
                  <?php echo render_textarea('_file_description', 'project_discussion_description', $file->description, ['onblur' => 'update_file_data(' . $file->id . ')']); ?>
