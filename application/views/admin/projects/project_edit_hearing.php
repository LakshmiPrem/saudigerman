...
<div class="modal-body">
  ...
  <div class="row">
   ...
   <div class="col-md-3 border-right" id="div_hearing_project" <?php if(isset($hearing)){?> style="pointer-events: none;"<?php }?>>
         ...
         <div class="col-md-3 border-right" id="div_stage_project" <?php if(isset($hearing)){?> style="pointer-events: none;"<?php }?>>
   ...
   <?php ####################### Subject ###################################################
    ...
    $value = (isset($hearing) ? $hearing->subject : ''); ?>
        ...
        <div class="col-md-3 border-right" <?php if(isset($hearing)){?> style="pointer-events: none;"<?php }?>>

<div class="form-group">

  <?php  
$mention_hearings=get_hearing_mention();
        $selected = (isset($hearing) ? $hearing->mention_hearing : 'hearing'); 

   echo render_select('mention_hearing',$mention_hearings,array('id','name'),'mention_hearing',$selected);?>
...
<?php #######################appeal_no ###############################################
  ...
  <?php ####################### Date ###################################################
            ...
            <?php echo render_datetime_input('hearing_date','mention_hearing_date',$value); ?>
...
<div class="form-group">
  ...
  <?php  
$mention_hearings=get_hearing_mention();
        $selected = (isset($hearing) ? $hearing->next_hearing_mention : ''); 

   echo render_select('next_hearing_mention',$mention_hearings,array('id','name'),'next_mention_hearing',$selected);?>

</div>

</div>

        <div class="col-md-3 border-right hide">
 ...
 #######################  {Proceedings} #######################################
        ...
        <?php echo render_textarea('proceedings','',$value,array(),array(),'','tinymce'); ?>
              ...
              <div class="input-group-btn ">
                   ...
                   <?php $value1 = (isset($hearing) ? $hearing->proceeding_en : ''); ?>  

                  <?php  echo render_textarea( 'proceeding_en', 'proceedings_en',$value1);?>
