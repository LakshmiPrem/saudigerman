...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('admin/projects/receiptinstallment/'.$project_id.'/'.$contactid,array('id'=>'contact-form','autocomplete'=>'off')); ?>
            ...
            <div class="modal-body">
             ...
             <?php //if((isset($contact) && $contact->installment_receipt == NULL) || !isset($contact)){ ?>
                             ...
                             <div class="form-group">
                                ...
                                <input type="file" name="installment_receipt" class="form-control" id="installment_receipt">

                             </div>

                        <?php if((isset($contact) && $contact->installment_receipt != NULL) ){

						$extension = pathinfo($contact->installment_receipt, PATHINFO_EXTENSION);
                        ...
                        <?php }else{ ?>   
                         ...
                         <iframe src="<?php echo base_url('uploads/installment/').$project_id.'/'.$contact->installment_receipt; ?>"></iframe>

               <a target="_blank" href=<?php echo base_url('uploads/installment/').$project_id.'/'.$contact->installment_receipt; ?> download ><i class="fa fa-download"></i></a>
