...
<div class="row">
	<div class="col-md-6">
		 <a class="btn btn-default mbot25 hide" data-toggle="collapse" href="#approval" role="button" aria-expanded="false" aria-controls="collapseExample">
 ...
 <!-- <a target="_blank" href="<?php echo admin_url('projects/expense_statement/'.$project->id); ?>" class="btn btn-warning btn-with-tooltip mleft25 mbot25" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Download Expense Statement"> <i class="fa fa-file-pdf-o"></i>Expense statement(Approve)  </a>-->
  <a target="_blank" href="<?php echo admin_url('projects/expense_statementall/'.$project->id); ?>" class="btn btn-success btn-with-tooltip mbot25 pull-right mright20" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Download Expense Statement"> <i class="fa fa-file-pdf-o"></i><?php echo _l('expense_statementall'); ?> </a>

  <a href="#" class="btn btn-info dropdown-toggle mright25 hide" type="button" data-toggle="dropdown"><i class="fa fa-file-pdf-o"></i> Expense Statement
