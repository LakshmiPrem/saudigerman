                ...
                <div class="panel-body">
                    <div class="_buttons">
                        <?php if (has_permission('staff','','create')) { ?>
                         <a href="<?php echo admin_url('staff/member?lawyer=y'); ?>" class="btn btn-info mright5 test pull-left display-block">
                            <?php echo _l('new_lawyer'); ?></a> 
                                <?php } ?>
                        ...
                        render_datatable($table_data,'lawyers');
                        ?>
                    </div>
                </div>
            </div>
...
<script>
    $(function(){
        ...
        var headers_clients = $('.table-lawyers').find('th');
        var not_sortable_clients = (headers_clients.length - 1);
        var tAPI = initDataTable('.table-lawyers', admin_url+'lawyers/table', [not_sortable_clients,0], [not_sortable_clients,0], CustomersServerParams,<?php echo hooks()->apply_filters('customers_table_default_order',json_encode(array(2,'ASC'))); ?>);
