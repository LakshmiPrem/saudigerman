...
<hr />
<?php if(isset($client)){ ?>
<?php echo form_open_multipart(admin_url('lawyers/upload_attachment/'.$client->lawyerid),array('class'=>'dropzone','id'=>'client-attachments-upload')); ?>
            ...
            <tbody>
                <?php foreach($attachments as $type => $attachment){
                    ...
                    if($type == 'invoice'){
                        ...
                        $url = site_url() .'download/file/lawyer/';
                        //$download_indicator = 'rel_id';
                    }
                    ?>
                    ...
                    <td>
                        ...
                        <?php if($type == 'lawyer'){ ?>
                        <a href="<?php echo admin_url('lawyers/delete_attachment/'.$_att['rel_id'].'/'.$_att['id']); ?>"  class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
                        <?php } ?>
                    </td>
                    <?php } ?>
                </tr>
...
<?php
include_once(APPPATH . 'views/admin/lawyers/modals/send_file_modal.php');
} ?>
