...
$tblhtml ='&nbsp;&nbsp;&nbsp;';
$tret1=0;$tret2=0;$tret3=0;$tsale1=0;
$tchq1=0;
$gchq1='Not Available';
if($legalapprove->civils->guarantee_cheque=="yes") $gchq1="Available";
$balc1='Not Available';
if($legalapprove->civils->balance_confirm=="yes") $balc1="Available";
...
$tblhtml .= '<br><div style="text-align:center;"> <h3 style="font-size:20px;">Request For Filing Police Case </h3></div>';
...
$tblhtml .= '<table width="100%" bgcolor="#fff" cellspacing="0" cellpadding="10" border="1"><thead></thead><tbody>
 <tr>
  ...
  <tr>
    <th width="35%">' . _l('police_case_reason') . '</th>
    <th width="65%">' . $legalapprove->civils->police_case_reason.'</th>
  </tr>
  <tr>
    <th width="35%">' . _l('amount_soa') . '</th>
    <th width="65%">' . $legalapprove->civils->amount_soa.'</th>
  </tr>
  <tr>
    <th width="35%">' . _l('cheque_nature') . '</th>
    <th width="65%">' . strtoupper($legalapprove->civils->cheque_nature).'</th>
  </tr>
  ...
  <tr>
    <th width="35%">' . _l('amt_police_case') . '</th>
    <th width="65%">' . $legalapprove->civils->amount_filed_case.'</th>
  </tr>
  <tr>
    <th width="35%">' . _l('balance_confirmation') . '</th>
    <th width="65%">' . $balc1.'</th>
  </tr>
  <tr>
    <th width="35%">' . _l('guarantee_cheque') . '</th>
    <th width="65%">' . $gchq1.'</th>
  </tr> 
   <tr nobr="true">
...
for($i=0;$i<$limit;$i++) {
    ...
    <th width="65%"><table width="100%" bgcolor="#fff" cellspacing="0" cellpadding="5" border="1"><thead></thead><tbody>
	<tr><td>'._l('owner_name').'</td><td>'._l('emirates_owner').'</td><td>'._l('contact1').'</td><td>'._l('contact2').'</td></tr>';
  ...
  <tr>
    <th width="35%">' . _l('company_status1') . '</th>
