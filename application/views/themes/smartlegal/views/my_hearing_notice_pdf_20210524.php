...
<tr>
  ...
  <tr>
    <th width="50%" style="text-align:center;">' . _l('case_number') . '</th>
    <th width="50%" style="text-align:center;">' . $hearing->case_number . '</th>
  </tr>
  <tr>  
    <th width="50%" style="text-align:center;">'._l('court').'</th>
    <th width="50%" style="text-align:center;">'./*$hearing->court_name*/'</th>
   </tr>
	<tr>
    <th width="50%" style="text-align:center;">' . _l('hearing_court_type') . '</th>
    <th width="50%" style="text-align:center;">' . /*$hearing->court_type_name*/  '</th>
  </tr>
  <tr>
