 ...
 <div class="modal-dialog" role="document">
  ...
  <div class="modal-body">
    ...
    <div id="identity_fields">
      ...
      <label for="acceptance_party" class="control-label col-sm-2">
        <span class="text-left inline-block full-width">
          <?php echo _l('first_second_party'); ?>
        </span>
      </label>
      <div class="col-sm-10">
      <?php $ind_party_types = get_signparty_types(); ?> 
                <?php echo render_select('first_second',$ind_party_types,array('id','name'),'','first_party') ?>
     </div>
   </div>
     <div class="form-group">
