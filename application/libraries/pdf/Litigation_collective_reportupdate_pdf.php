...
class Litigation_collective_reportupdate_pdf extends App_pdf
{
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_litigation_collective_reportupdate_pdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_litigation_collective_reportupdate_pdf.php';
