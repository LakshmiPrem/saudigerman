...
class Legalcontract_approval_pdf extends App_pdf
{
    ...
    {
			$contractid = $this->legalapprove->id;
			$legaltasks = $this->ci->tickets_model->get_ticket_tasks($contractid);
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_legalcontract_approval_pdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/legalcontract_approval_pdf.php';
