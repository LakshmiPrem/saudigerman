...
class Legal_creditapplication_approval_pdf extends App_pdf
{
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_legal_creditapplication_approval_pdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/legal_creditapplication_approval_pdf.php';
