...
class Expense_statement_pdf extends App_pdf
{
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_expenseapprove_pdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/expenseapprove.php';
