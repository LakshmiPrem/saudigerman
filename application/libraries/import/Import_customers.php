...
class Import_customers extends App_import
{
    ...
    {
        $this->notImportableFields = hooks()->apply_filters('not_importable_clients_fields', ['userid', 'id', 'is_primary', 'password', 'datecreated', 'last_ip', 'last_login', 'last_password_change', 'active', 'new_pass_key', 'new_pass_key_requested', 'leadid', 'default_currency', 'profile_image', 'default_language', 'direction', 'show_primary_contact', 'invoice_emails', 'estimate_emails', 'project_emails', 'task_emails', 'contract_emails', 'credit_note_emails', 'ticket_emails', 'addedfrom', 'registration_confirmed', 'last_active_time', 'email_verified_at', 'email_verification_key', 'email_verification_sent_at','is_owner','is_partner','stakeholder_id','is_manager','is_director','is_secretary','billing_street','billing_city','billing_state','billing_country','billing_zip','shipping_street','shipping_city','shipping_state','shipping_zip','shipping_country','longitude','latitude','stripe_id','refered_employee_id','source','commission_percentage','nationality','emirates_id','legal_count','company_type','parent_company']);
